	...
	<li>
		<a href="javascript:;" menu_id="2" parent="0">
			...
			<span class="title">My Record</span>
					...
					<li ><a rel="<?php echo site_url('account/calendar');?>" href="<?php echo site_url('account/calendar');?>" menu_id="24" parent="2">Calendar Application</a></li>
	...
	<li>
		<a href="javascript:;" menu_id="3" parent="0">
			...
			<span class="title">Employee</span>
					...
					<li ><a rel="<?php echo site_url('partners/loan_application_manage');?>" href="<?php echo site_url('partners/loan_application_manage');?>" menu_id="131" parent="3">Loan Application Manage</a></li>
							</ul>
			</li>
	<li>
