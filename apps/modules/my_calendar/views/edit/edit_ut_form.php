				...
				<div class="portlet">
                    <div class="portlet-body form">
                            ...
                            <div class="form-body"> 
								...
								<div class="form-group">
									<label class="control-label col-md-4"><?php echo lang('my_calendar.ut_date') ?><span class="required">* </span></label>
									<div class="col-md-7">							
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4"><?=lang('my_calendar.date_time')?><span class="required">*</span></label>
                                    <div class="col-md-7">
                                        <div class="input-group date form_datetime" data-date-format="MM dd, yyyy - HH:ii p">
                                            <input <?= $disabled?> type="text" size="16" class="form-control" id="ut_time_in_out" name="ut_time_in_out" value="<?php echo $ut_time_in_out; ?>">
                                            <span class="input-group-btn">
...
<script>
	...
	function check_ut_type(ut_type){
		if(ut_type == 1){
			$('.modal-title').html('Undertime Form (IN)');
		}else{
			$('.modal-title').html('Undertime Form (OUT)');
  		}
  	}
	</script>