<div class="portlet">
	...
	<div class="portlet-body form">			
		...
		<div class="form-group hidden">
			...
			<div class="col-md-7">
			<?php									                            		
				$db->select('applicable_for_id,applicable_for');
				$db->order_by('applicable_for', '0');
				$db->where('deleted', '0');
				$options = $db->get('training_applicable_for');
				$training_evaluation_template_applicable_for_options = array('' => 'Select...');
		...
		<div class="form-group">
			...
			<div class="col-md-7">							
				<textarea class="form-control" name="training_evaluation_template[description]" id="training_evaluation_template-description" placeholder="Enter Description" rows="4">{{ $record['training_evaluation_template.description'] }}</textarea> 				
			</div>	
		</div>	
	</div>
</div>
