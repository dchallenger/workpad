<div class="portlet">
	...
	<div class="portlet-body form">
		<div class="form-group">
			...
			<div class="col-md-5">
                ...
                <div class="input-group">
                    ...
                    {{ form_dropdown('performance_planning[year]',$performance_planning_year_options, $record['performance_planning.year'], 'class="form-control select2me" data-placeholder="Select..." id="performance_planning-year" disabled') }}
                    <input type="hidden" class="form-control" name="performance_planning[year]" value="{{ $record['performance_planning.year'] }}" />
                </div> 					
		...
		<div class="form-group">
			...
			<div class="col-md-5"><?php									                            		
				...
				<div class="input-group">
					...
					{{ form_dropdown('performance_planning[performance_type_id]',$performance_planning_performance_type_id_options, $record['performance_planning.performance_type_id'], 'class="form-control select2me" data-placeholder="Select..." disabled') }}
					<input type="hidden" class="form-control" name="performance_planning[performance_type_id]" value="{{ $record['performance_planning.performance_type_id'] }}" />
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-6">
				<div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
					<input type="text" class="form-control" name="performance_planning[date_from]" id="performance_planning-date_from" value="{{ $record['performance_planning.date_from'] }}" placeholder="Enter Date From" disabled>
					<input type="hidden" class="form-control" name="performance_planning[date_from]" value="{{ $record['performance_planning.date_from'] }}">
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
					<input type="text" class="form-control" name="performance_planning[date_to]" id="performance_planning-date_to" value="{{ $record['performance_planning.date_to'] }}" placeholder="Enter Date To" disabled>
					<input type="hidden" class="form-control" name="performance_planning[date_to]" value="{{ $record['performance_planning.date_to'] }}">
					<span class="input-group-btn">
		...
		<div class="form-group">
			...
			<div class="col-md-5">
				<div class="make-switch" data-on-label="&nbsp;{{ lang('performance_planning.open') }}&nbsp;" data-off-label="&nbsp;{{ lang('performance_planning.close') }}&nbsp;">
					<input type="checkbox" value="1" @if( $record['performance_planning.status_id'] || empty($record_id) ) checked="checked" @endif name="performance_planning[status_id][temp]" id="performance_planning-status_id-temp" class="dontserializeme toggle" disabled/>
		...
		<div class="form-group">
			...
			<div class="col-md-5">
				<textarea class="form-control" name="performance_planning[notes]" id="performance_planning-notes" placeholder="Enter Notes" rows="4" readonly>{{ $record['performance_planning.notes'] }}</textarea>
			</div>
		</div>			
...
<div class="portlet">
	...
	<div class="portlet-body form">		
		...
		<div class="form-group hidden">
			<label class="control-label col-md-4">
				{{ lang('performance_planning.remarks') }}
			</label>
			<div class="col-md-5">
				<textarea class="form-control" name="performance_planning[immediate_remarks]" id="performance_planning-immediate_remarks" placeholder="Enter Remarks" rows="4">{{ $record['performance_planning.immediate_remarks'] }}</textarea>
			</div>
		</div>				
	</div>
</div>
<div id="planning_section">
