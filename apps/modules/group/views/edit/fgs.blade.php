<div class="portlet">
	...
	<div class="portlet-body form">			
		<div class="form-group">
			...
			<div class="col-md-7">							
				<input type="text" class="form-control" name="users_group[group]" id="users_group-group" value="{{ $record['users_group.group'] }}" placeholder="{{ lang('group.p_group') }}"/> 				
			</div>
		</div>			
		<div class="form-group">
			<label class="control-label col-md-3"><span class="required">* </span>{{ lang('group.group_code') }}</label>
			<div class="col-md-7">							
				<input type="text" class="form-control" name="users_group[group_code]" id="users_group-group_code" value="{{ $record['users_group.group_code'] }}" placeholder="{{ lang('group.p_group_code') }}"/> 				
			</div>
		</div>			
		<div class="form-group">
			...
			<div class="col-md-7"><?php	                            	                            		$db->select('user_id,display_name');
        		...
        		<div class="input-group">
                    ...
                    {{ form_dropdown('users_group[immediate_id]',$users_group_immediate_id_options, $record['users_group.immediate_id'], 'class="form-control select2me" id="group-immediate_id" data-placeholder="Select..."') }}
                </div> 				
        	</div>	
		</div>			
		<div class="form-group">
			...
			<div class="col-md-7">							
				<input type="text" class="form-control" name="users_group[position]" id="users_group-position" value="{{ $record['users_group.position'] }}" placeholder="{{ lang('group.p_immediate_position') }}"/> 				
			</div>	
		</div>			
		<div class="form-group">
