<div class="portlet">
	...
	<div class="portlet-body form">			
        <div class="form-group">
			...
			<div class="col-md-7">							
                <input type="text" class="form-control" name="payroll_entry_batch[document_no]" id="payroll_entry_batch-document_no" value="{{ $record['payroll_entry_batch_document_no'] }}" placeholder="Enter Document No." readonly/> 				
            </div>	
		</div>			
        <div class="form-group">
			...
			<div class="col-md-7">
                <?php									                            		
                    ...
                    $payroll_entry_batch_transaction_id_options = array('' => 'Select...');
                ...
                <div class="input-group">
                    ...
                    {{ form_dropdown('payroll_entry_batch[transaction_id]',$payroll_entry_batch_transaction_id_options, $record['payroll_entry_batch_transaction_id'], 'class="form-control select2me" data-placeholder="Select..." disabled') }}
                </div> 				
            </div>	
		</div>			
        <div class="form-group">
			...
			<div class="col-md-7">							
                <div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
					<input type="text" class="form-control" name="payroll_entry_batch[payroll_date]" id="payroll_entry_batch-payroll_date" value="{{ $record['payroll_entry_batch_payroll_date'] }}" placeholder="Enter Payroll Date" readonly>
        ...
        <div class="form-group">
			...
			<div class="col-md-7">							
                <input type="text" class="form-control" name="payroll_entry_batch[unit_rate_main]" id="payroll_entry_batch-unit_rate_main" value="{{ $record['payroll_entry_batch_unit_rate_main'] }}" placeholder="Enter Unit Rate" data-inputmask="'alias': 'decimal', 'autoGroup': true, 'groupSeparator': ',', 'groupSize': 3, 'repeat': 13, 'greedy' : false" readonly/> 				
            </div>	
		</div>			
        <div class="form-group">
			<label class="control-label col-md-3">Remarks</label>
			<div class="col-md-7">							
                <textarea class="form-control" name="payroll_entry_batch[remarks]" id="payroll_entry_batch-remarks" placeholder="Enter Remarks" rows="4" readonly>{{ $record['payroll_entry_batch_remarks'] }}</textarea> 				
            </div>	
		</div>	
    </div>
</div>
