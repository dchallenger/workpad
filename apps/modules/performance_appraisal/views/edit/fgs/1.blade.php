<div class="portlet">
	<div class="portlet-title">
		<div class="caption">Appraisal</div>
		...
		<div class="portlet-body form">			<div class="form-group">
				...
				<label class="control-label col-md-3">Employment Status Filter</label>
				...
				<label class="control-label col-md-3"><span class="required">* </span>Planning</label>
