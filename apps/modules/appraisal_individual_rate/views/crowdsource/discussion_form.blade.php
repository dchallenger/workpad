    ...
    <div class="chat-form margin-bottom-20 margin-top-0 @if($status_id=='-1') hidden @endif">
        <form id="note-form">
            ...
            <div class="btn-cont"> 
                ...
                <a href="#" class="btn blue icn-only cs_discussion_button"><i class="fa fa-comments-o icon-white"></i></a>
            </div>
            <span style="margin-top: 10px;" class="pull-left small text-muted">Click Submit To to send comment.</span>
            
            @if( sizeof($contributor)  )
            <span style="margin-top: 6px;" class="pull-right"> 
                <a class="btn btn-sm green icn-only cs_discussion_button"> Submit To: {{ $sent_to }}</a>
            </span>
            @endif
        </form>
    </div>
