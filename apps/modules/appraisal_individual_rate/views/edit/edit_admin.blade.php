							...
							<td>
								<div class="form-group">
									...
									<div class="col-md-8">
										...
										<input type="text" name="committee_rating" class="form-control" value="{{ $appraisee->committee_rating }}" {{$readonly}}>
									</div>
								</div>
							</td>
						</tr>					
								...
								switch( $child->section_type_id )
								{
									case 2: //balance Scorecard ?>
										<div class="panel panel-success">
											...
											@include('summary/sections/edit_balance_scorecard', array('performance_status_id' => $appraisee->performance_status_id, 'appraisee_user_id' => $appraisee->user_id,'self_rating' => $self_rating, 'login_user_id' => $login_user_id, 'section_info' => $child,'section_id' => $child->template_section_id, 'header' => $child->header, 'footer' => $child->footer))
										</div> <?php 
										break;
									case 3: //core competencies?>
										...
										case 9: //IDP?>
											<div class="panel panel-success">
												...
												@include('edit/sections/idp', array('performance_status_id' => $appraisee->performance_status_id, 'appraisee_user_id' => $appraisee->user_id, 'self_rating' => $self_rating, 'login_user_id' => $login_user_id, 'section_info' => $child, 'section_id' => $child->template_section_id, 'library_id' => $child->library_id, 'header' => $child->header, 'footer' => $child->footer))
											</div> <?php
											break;											
									default:
								}
