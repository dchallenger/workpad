                    ...
                    <!-- BEGIN FORM-->
                        <div class="form-body">
                            ...
                            <div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('loan_application.loan_amount') }} :</label>
										<div class="col-md-7 col-sm-7">
											<span>{{ $record['partners_loan_application_omnibus_loan_amount'] }}</span>
										</div>
									</div>
								</div>
							</div>										
                            <div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('loan_application.loan_purposes') }} :</label>
										<div class="col-md-7 col-sm-7">
											<span>{{ $record['partners_loan_application_omnibus_loan_purposes'] }}</span>
										</div>
									</div>
								</div>
							</div>	
                            <div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-7 col-sm-7">
											<span>{{ $record['partners_loan_application_omnibus_loan_terms'] }}</span>
										</div>
									</div>
								</div>
							</div>
                            ...
                            <div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-7 col-sm-7">
											<span>{{ $record['partners_loan_application_omnibus_loan_deduction_start'] }}</span>
										</div>
									</div>
								</div>
							</div>
                            <div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-7 col-sm-7">
											<span>{{ $record['partners_loan_application_omnibus_loan_deduction_end'] }}</span>
										</div>
									</div>
								</div>
							</div>
                            <div class="row hidden">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-7 col-sm-7">
											<span>{{ $record['partners_loan_application_omnibus_loan_amount_to_deduct'] }}</span>
										</div>
									</div>
								</div>
							</div>
                            <div class="row hidden">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-7 col-sm-7">
											<span>{{ $record['partners_loan_application_omnibus_loan_amount_to_deduct_per_day'] }}</span>
										</div>
									</div>
								</div>
							</div>
                                ...
                                <div class="col-md-12">
	                                <div>
	                                	<?php if( $loan_application_approver_details['approver_status_id'] < 6 && in_array($loan_application_approver_details['loan_application_status_id'], array(2,4,5)) && $record['partners_loan_application_status_id'] != 8 && $record['partners_loan_application_status_id'] != 6){ ?>
	                                		...
	                                		<a href="#" class="disapprove_view btn btn-sm btn-danger" data-loan-type="{{ $loan_application_approver_details['loan_type'] }}" data-loan-application-id="{{ $loan_application_approver_details['loan_application_id'] }}" data-loan-application-owner="{{ $loan_application_approver_details['user_id'] }}" data-user-name="" data-user-id="{{ $loan_application_approver_details['approver_id'] }}" data-decission="0" >{{ lang('loan_application.disapprove') }}</a>
	                                	<?php }
