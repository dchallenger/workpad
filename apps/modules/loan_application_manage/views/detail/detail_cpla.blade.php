                ...
                <div class="portlet-body form" id="main_form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('loan_application.entitlement') }} :</label>
									<div class="col-md-7 col-sm-7">
										<span>{{ $record['partners_loan_application_car_loan_application_car_entitlement'] }}</span>
									</div>
								</div>
							</div>
						</div>										
                        <div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('loan_application.year_model') }} :</label>
									<div class="col-md-7 col-sm-7">
										<span>{{ $record['partners_loan_application_car_year_model'] }}</span>
									</div>
								</div>
							</div>
						</div>	
                        <div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('loan_application.car_type') }} :</label>
									<div class="col-md-7 col-sm-7">
										<span>{{ $record['partners_loan_application_car_car_type'] }}</span>
									</div>
								</div>
							</div>
						</div>						
                        <div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('loan_application.amount_loan') }} :</label>
									<div class="col-md-7 col-sm-7">
										<span>{{ currency_format($record['partners_loan_application_car_loan_amount']) }}</span>
									</div>
								</div>
							</div>
						</div>
