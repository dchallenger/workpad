				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">{{ lang('loan_application.title') }}</div>
							<div class="tools">
									 ...
									 ?>
										<li class="media">
											<a class="hidden-xs pull-left" href="#">
												<i class="{{ $type['class'] }}" style="color:#646464;font-size:24px;line-height:24px;"></i>
											</a>
											<div class="media-body">
												<h4 class="media-heading">{{ $type['loan_type'] }}</h4>
												<p class="small">
													{{ $type['description'] }} 
												</p>
												<a href="{{ get_mod_route('loan_application', 'add/' . strtolower($type['loan_type_code'])) }}" class="btn btn-xs green">{{ lang('loan_application.apply') }}<i class="fa fa-arrow-circle-o-right"></i></a> 
											</div>
										</li>							
									<?php
									 	} 
