...
JOIN `ww_partners_loan_application_approver` ON `ww_partners_loan_application`.`loan_application_id` = `ww_partners_loan_application_approver`.`loan_application_id`
JOIN `ww_users` ON `ww_partners_loan_application`.`user_id` = `ww_users`.`user_id`
