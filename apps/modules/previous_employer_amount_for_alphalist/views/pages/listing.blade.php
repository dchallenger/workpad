	...
	<ul class="page-breadcrumb breadcrumb">
		@section('page-breadcrumb-back')
			<li class="pull-right btn-group" style="position:relative;">
				...
				<span>{{ lang('payroll_previous_employer_alphalist.back') }}</span>
				</button></a>
			</li>
		@show
		<li class="btn-group">
			...
			<ul role="menu" class="dropdown-menu pull-right">
				<li><a href="{{ $mod->url }}"><i class="fa fa-refresh"></i> {{ lang('payroll_previous_employer_alphalist.refresh') }}</a></li>
				
				<li class="hidden import-button"><a href="javascript:void(0)" onclick="mod_import({{ $mod->mod_id }})"><i class="fa fa-cloud-download"></i> {{ lang('position.import') }}</a></li>
				<li class="divider hidden"></li>
				<li class="hidden"><a href="#"><i class="fa fa-cloud-upload"></i> {{ lang('payroll_previous_employer_alphalist.export') }}</a></li>
			</ul>
		</li>
		<li>
			<i class="fa fa-home"></i>
			<a href="{{ base_url('') }}">{{ lang('payroll_previous_employer_alphalist.home') }}</a> 
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="{{ site_url('payroll/setup') }}">{{ lang('payroll_previous_employer_alphalist.payroll_setup') }}</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
