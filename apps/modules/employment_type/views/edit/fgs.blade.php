<div class="portlet">
	...
	<div class="portlet-body form">			
		<div class="form-group">
			...
			<div class="col-md-7">							
				<input type="text" class="form-control" name="partners_employment_type[employment_type]" id="partners_employment_type-employment_type" value="{{ $record['partners_employment_type.employment_type'] }}" placeholder="{{ lang('employment_type.p_employment_type') }}"/>
			</div>
		</div>	
		<div class="form-group">
