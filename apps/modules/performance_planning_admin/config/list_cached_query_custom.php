...
LEFT JOIN `ww_performance_planning_approver` T6 ON `T6`.`user_id` = `ww_performance_planning_applicable`.`user_id` AND  `T6`.`planning_id` = `ww_performance_planning_applicable`.`planning_id`
WHERE (
