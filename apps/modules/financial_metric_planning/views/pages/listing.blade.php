				...
				<div class="portlet-body">
					<div >
						<ul class="nav nav-tabs ">
							<li class="active"><a href="{{ $mod->url }}">{{ lang('financial_metric.financial_metric_planning') }}</a></li>
							@if($financial_metric_self_rating)
								<li><a href="{{ get_mod_route('financial_metric_self_rating') }}">{{ lang('financial_metric.financial_metric_self_rating') }}</a></li>
							@endif
							@if ($financial_metric_coach_rating)
								<li><a href="{{ get_mod_route('financial_metric_coach_rating') }}">{{ lang('financial_metric.financial_metric_coach_rating') }}</a></li>
							@endif
						</ul>
					</div>
				</div>
