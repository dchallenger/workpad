	...
	<div class="portlet-title">
		...
		<div class="portlet-body form">		
			...
			<div class="form-group">
				...
				<div class="col-md-7">							
					<input type="text" class="form-control" name="time_shift[shift]" id="time_shift-shift" value="{{ $record['time_shift_shift'] }}" placeholder="Enter Shift" />
				</div>	
			</div>
			<div class="form-group">
				...
				<div class="col-md-7">
					<div class="input-group bootstrap-timepicker">                                       
						<input type="text" class="form-control timepicker-default" name="time_shift[time_start]" id="time_shift-time_start" value="{{ date('h:i A',strtotime($record['time_shift_time_start'])) }}" />
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<div class="input-group bootstrap-timepicker">                                       
						<input type="text" class="form-control timepicker-default" name="time_shift[time_end]" id="time_shift-time_end" value="{{ date('h:i A',strtotime($record['time_shift_time_end'])) }}" />
						<span class="input-group-btn">
							<button class="btn default" type="button"><i class="fa fa-clock-o"></i></button>
						</span>
					</div>
			...
			<div class="form-group">
				...
				<div class="col-md-7">
                    <div class="make-switch" data-off="danger" data-on="success" data-on-label="&nbsp;{{ lang('common.yes') }}&nbsp;" data-off-label="&nbsp;{{ lang('common.no') }}&nbsp;">
				    	<input type="checkbox" value="1" {{ ($record['time_shift_use_tag'] == 1) ? 'checked="checked"' : ''  }}  class="dontserializeme toggle" id="time_shift-use_tag-temp"/>
				    	<input type="hidden" name="time_shift[use_tag]" id="time_shift-use_tag" value="{{ $record['time_shift_use_tag'] }}"/>
					</div>
