...
@endif
<button type="button" class="btn green btn-sm" onclick="change_status( $(this).closest('form'), 2 )"><i class="fa fa-check"></i> {{ lang('appraisal_individual_planning.send_to_approver') }}</button>
