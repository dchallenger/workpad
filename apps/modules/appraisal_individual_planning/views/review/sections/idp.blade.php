					...
					<tr class="">
						...
						?>
											<td width="{{ $value->width }}" rowspan="">
												<select class="form-control" name="field[0][{{ $value->section_column_id }}][]" section-id="{{ $section_id }}" {{ $disabled }}>
						...
						?>
											<td width="{{ $value->width }}" rowspan="">
												<select class="form-control" ratio-weight="" name="field[0][{{ $value->section_column_id }}][]" section-id="{{ $section_id }}" {{ $disabled }}>
													<option value="0">Select</option>													
						...
						?>
											<td width="{{ $value->width }}" rowspan="">
												<textarea class="form-control" rows="2" name="field[0][{{ $value->section_column_id }}][]" {{ $disabled }}>{{ $planning_value }}</textarea>
											</td>										
						<?php											
										break;								
									}
