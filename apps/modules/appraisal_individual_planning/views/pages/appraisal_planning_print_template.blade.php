...
<html lang="en">
    ...
    <body bgcolor="#ffffff" topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" style="-webkit-font-smoothing: antialiased; width: 100% !important; -webkit-text-size-adjust: none;">
        ...
        <p align="center">PERFORMANCE APPRAISAL PLANNING FORM</p><br>
		...
		<table align='center' cellpadding="2px" cellspacing="0" style='width: 100%; height: auto; background: #fff'>
			<tbody>
                ...
                <tr>
                    <td align="left" style="<?php echo $bltb ?>">Company</td>
                    <td style="<?php echo $bltb ?>"><?php echo $appraisee->company ?></td>
                    <td align="left" style="<?php echo $bltb ?>">Level</td>
                    <td style="<?php echo $bltrb ?>"><?php echo $appraisee->employment_type ?></td>                         
                </tr>
<!--                 <tr>
                    ...
                    <div class="portlet-body">
                        <div class="clearfix"> <?php
                            foreach( $section->children as $child ):
                                ...
                                $columns_arr = $columns->result_array();
                                ...
                                switch( $child->section_type_id )
                                {
                                    case 2: //balance Scorecard ?>
                                        <table align='center' cellpadding="2px" cellspacing="0" style='width: 100%; height: auto; background: #fff'>
                                            <thead>
                                                <tr>
                                                    <th colspan="6" align="left" style="<?php echo $bltr ?>"><?php echo $child->template_section ?> (<?php echo $child->weight ?>%)</th>
                                                </tr>
                                                <tr>
                                                    <?php foreach($columns_arr as $key => $val) { ?>
                                                        <th width="" class="bold" align="left" style="<?php echo (array_key_last($columns_arr) == $key ? $bltr : $blt) ?>">
        ...
        <table align='center' cellpadding="2px" cellspacing="0" style='width: 100%; height: auto; background: #fff'>
            ...
            <tbody>
                <?php if(isset($template_section) && $template_section->num_rows() > 0) { ?>
                    ...
                    <?php } ?>
                    <tr>
                        <td class="bold" style="<?php echo $bltb ?>"><b>Total Weighted Score</b></td>
                        <td class="total_weighted_score" style="<?php echo $bltb ?>"><?php echo array_sum($key_weight_arr) ?>%</td>
                        <td style="<?php echo $bltb ?>"></td>
                        <td style="<?php echo $bltb ?>"></td>
                        <td style="<?php echo $bltb ?>"></td>
                        <td style="<?php echo $bltb ?>"></td>
                        <td style="<?php echo $bltb ?>"></td>
                        <td class="bold" style="<?php echo $bltb ?>"></td>
                        <td class="self_rating" style="<?php echo $bltrb ?>"><?php echo $appraisee->self_rating ?></td>
                    </tr>
<!--                     <tr>
                        <td style="<?php echo $bltb ?>"></td>
                        <td style="<?php echo $bltb ?>"></td>
