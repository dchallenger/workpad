...
<h5>Filter Employees:</h5>
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <select class="form-control employees_list" data-placeholder="Select..." name="partners[partner_id][]" id="partners-partner_id" <?php echo ($multiple == 1 ? 'multiple="multiple"' : '') ?>>
                <?php 
