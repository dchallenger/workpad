						...
						<div class="form-group">
							...
							<div class="col-md-6">
	                            ...
	                            <div class="input-group">
		                            ...
		                            {{ form_dropdown('users_division[division_id][]',$division_id_options, $record['users_division.division_id'], 'class="form-control " data-placeholder="Select..." multiple="multiple" id="users_division-division_id"') }}
		                        </div>
	                    	</div>
	                    </div>	                    
						<div class="form-group">
