	                        ...
	                        <!-- BEGIN FORM-->
	                            <div class="form-body">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">Date :</label>
												<div class="col-md-7 col-sm-7">
													<span><?php echo date('F d, Y - D',strtotime($record['time_forms_date_to'])) ?></span>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">Work Schedule :</label>
												<div class="col-md-7 col-sm-7">
													<span><?php echo $record['time_forms_date_shift']; ?></span>
												</div>
											</div>
										</div>
									</div>
			                         ...
			                         ?>
				                         ...
				                         <div class="col-md-7 col-sm-7">
		                                    <span style='display:block; word-wrap:break-word;'>
		                                        ...
		                                        <?php
		                                            if(strtotime($remarks[$j]['comment_date']))
