        ...
        <div class="col-md-9">
				...
				<div id="vl_container" class="portlet">
						<div class="portlet-title">
							<div class="caption">Undertime Form <small class="text-muted">view</small></div>
						</div>
	                        ...
	                        <!-- BEGIN FORM-->
	                            <div class="form-body">
	                                ...
	                                <div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">Undertime Date :</label>
												<div class="col-md-7 col-sm-7">
	                                ...
	                                <div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">Date / Time:</label>
												<div class="col-md-7 col-sm-7">
													<span>{{ $ut_time_in_out }}</span>
												</div>
											</div>
										</div>
									</div>
