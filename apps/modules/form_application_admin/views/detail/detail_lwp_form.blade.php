													    ...
													    ?>
													    		<div style="word-wrap:break-word;" class="<?php if( $countSelectedDates > 4 ) echo 'hidden'; ?> toggle-<?php echo $countSelectedDates; ?>">
						                                    		...
						                                    		<div class="col-md-4 padding-none">
																		<select class="duration form-control select2me" data-placeholder="Select..." name="duration[]" id="duration[]" class="duration" style="display: inline-block;width: 140px;">
						                                    		...
						                                    		<div class="col-md-3 padding-none">
													                    @if ($form_approver_details['approver_status_id'] == 6 && $form_approver_details['within_cutoff'])
													                    	<span style="padding-left:5px"><input type="checkbox" value="" class="toggle" id="ut_type-temp" name="cancel[]" class="" checked /> Cancel</span>
													                    @endif
						                                    		</div>
						                                    	</div>
						                                  		<?php 
