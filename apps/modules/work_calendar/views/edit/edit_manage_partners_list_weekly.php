            ...
            <div class="col-md-3">
                <div class="portlet">
                    <div class="portlet-body" >
                        <input type="hidden" name="type" value="weekly" id="work_shift_type">
                        ...
                        <table id="partners-list-table" class="table table-condensed table-striped table-hover" >
                            ...
                            <tbody>
                                ...
                                <tr rel="0">
                                    ...
                                    <td>
                                        <?php echo (isset($partners[$i]['calendar']) ? $partners[$i]['calendar'] : '') ; ?>
                                    </td>
                                    <td>
                                        <select  
...
<script>
    ...
    var getSearchData = function(keyword){
        ...
        var work_shift_type = $('#work_shift_type').val();

        var data = {keyword: keyword,type: work_shift_type};
