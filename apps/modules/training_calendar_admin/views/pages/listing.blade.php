				...
				<div class="portlet-body">
					<div >
						<ul class="nav nav-tabs ">
							...
							<li><a href="{{ get_mod_route('training_calendar') }}">{{ lang('common.personal') }}</a></li>
							@endif
							...
							<li class="active"><a href="{{ get_mod_route('training_calendar_admin') }}">{{ lang('common.admin') }}</a></li>
							@endif
						</ul>
					</div>
				</div>
