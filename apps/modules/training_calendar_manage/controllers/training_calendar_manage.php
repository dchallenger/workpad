...
class Training_calendar_manage extends MY_PrivateController
{
	public function __construct()
	{
		$this->load->model('training_calendar_manage_model', 'mod');
...
*/
        ...
        $data['training_calendar_manage'] = isset($this->permission['list']) ? $this->permission['list'] : 0;
