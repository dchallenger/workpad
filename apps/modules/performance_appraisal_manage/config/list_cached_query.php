...
T9.filter_by as "performance_appraisal_filter_by", 
ww_performance_appraisal_applicable.user_id as "performance_appraisal_applicable_user_id", 
ww_performance_appraisal.filter_id as "performance_appraisal_filter_id", 
ww_performance_appraisal.notes as "performance_appraisal_notes", 
IF(ww_performance_appraisal.status_id = 1, "Yes", "No") as "performance_appraisal_status_id", 
ww_performance_appraisal.template_id as "performance_appraisal_template_id", 
T4.performance as "performance_appraisal_performance_type_id", 
DATE_FORMAT(ww_performance_appraisal.date_to, \'%M %d, %Y\') as "performance_appraisal_date_to", 
DATE_FORMAT(ww_performance_appraisal.date_from, \'%M %d, %Y\') as "performance_appraisal_date_from", 
...
T5.`full_name` as "performance_appraisal_immediate"
...
LEFT JOIN `ww_users` T5 ON `T5`.`user_id` = `ww_performance_appraisal`.`created_by`
LEFT JOIN `ww_performance_appraisal_approver` T6 ON `T6`.`appraisal_id` = `ww_performance_appraisal`.`appraisal_id`
WHERE (
