...
class Performance_appraisal_manage extends MY_PrivateController
{
    ...
    public function index()
    {
        ...
        $data['allow_personal'] = ($permission != 0 ? $permission['list'] : $permission);
    ...
    function _list_options_active( $record, &$rec )
    {
        ...
        $rec['view_employees_url'] = '<a href="'.$this->appraise_admin->url . '/index/' . $record['record_id'].'"><i class="fa fa-user"></i> ' . lang('performance_appraisal_manage.view_emp') . '</a>';
