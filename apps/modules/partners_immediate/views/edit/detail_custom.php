	...
	<div class="row">
		<div class="col-md-12">
			...
			<ul class="page-breadcrumb breadcrumb">				
				<li class="btn-group">
					<a href="<?php echo get_mod_route('partners_immediate');?>"><button type="button" class="btn blue">
					<span>Back</span>
					</button></a>
				</li>
				<li>
						...
						<div class="portlet sale-summary margin-bottom-0">
							<div class="portlet-body">
								<ul class="list-unstyled">
									<li><h5 class="margin-bottom-0"><?=lang('partners_immediate.quick_info')?></h5>
									</li>
									<li>
										<span class="text-muted"><i class="fa fa-calendar"></i>&nbsp; <?=lang('partners_immediate.bday')?></span> 
										<span class="pull-right" id="birthday"> {{$profile_birthdate}}</span>
										<br />
										<span class="pull-right small text-muted"> {{$profile_age}} yrs old</span>
									</li>
									<li>
										<span class="text-muted"><i class="fa fa-map-marker"></i>&nbsp; <?=lang('partners_immediate.livein')?></span> 
										<span class="pull-right" id="city"> {{$profile_live_in}}</span>
										<br />
										<span class="pull-right small text-muted"> {{$profile_country}}</span>
									</li>
									<li>
										<span class="text-muted"><i class="fa fa-user"></i>&nbsp; <?=lang('partners_immediate.civil_status')?></span> 
