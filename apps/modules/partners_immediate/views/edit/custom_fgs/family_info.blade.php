<div class="portlet">
    <div class="portlet-title">
        <div class="caption" id="family-category">{{ lang('partners_immediate.family') }}</div>
        <div class="tools">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="help-block">
                            {{ lang('partners_immediate.select_relationship') }}
                        </div>
                        <!-- /input-group -->
                    </div>
                </div>
                ...
                <div class="portlet-body form">
                    <div class="form-horizontal">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">{{ lang('partners_immediate.age') }}</label>
                                <div class="col-md-5">
