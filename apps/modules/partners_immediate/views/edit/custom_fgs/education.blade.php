    		...
    		<!-- START FORM -->	
    				<div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            value="<?php echo (isset($education['education-school']) ? $education['education-school'] : ""); ?>" placeholder="{{ lang('partners_immediate.enter') }} {{ lang('partners_immediate.school') }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            value="<?php echo (isset($education['education-year-from']) ? $education['education-year-from'] : ""); ?>" placeholder="{{ lang('partners_immediate.enter') }} {{ lang('partners_immediate.year_from') }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            value="<?php echo (isset($education['education-year-to']) ? $education['education-year-to'] : ""); ?>" placeholder="{{ lang('partners_immediate.enter') }} {{ lang('partners_immediate.year_to') }}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            value="<?php echo (isset($education['education-degree']) ? $education['education-degree'] : ""); ?>" placeholder="{{ lang('partners_immediate.enter') }} {{ lang('partners_immediate.degree') }}"/>
                        </div>
                    </div>
                    <?php 
                    }else{
