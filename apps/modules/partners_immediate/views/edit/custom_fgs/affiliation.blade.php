<div class="portlet">
	<div class="portlet-title">
		<div class="caption" id="education-category">{{ lang('partners_immediate.affiliation') }}</div>
		<div class="actions">
	...
	<div class="portlet-body form">
		...
		<!-- START FORM -->
               <div class="form-group">
                    <label class="control-label col-md-3">{{ lang('partners_immediate.affiliation_name') }}<span class="required">*</span></label>
                    <div class="col-md-6">
