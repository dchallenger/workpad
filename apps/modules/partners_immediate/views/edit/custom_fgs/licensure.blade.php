		...
		<!-- START FORM -->	                
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        value="<?php echo (isset($licensure['licensure-title']) ? $licensure['licensure-title'] : ""); ?>" placeholder="{{ lang('partners_immediate.enter') }} {{ lang('partners_immediate.title') }}"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        value="<?php echo (isset($licensure['licensure-number']) ? $licensure['licensure-number'] : ""); ?>" placeholder="{{ lang('partners_immediate.enter') }} {{ lang('partners_immediate.license_no') }}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">{{ lang('partners_immediate.date_taken') }}<span class="required">*</span></label>
                        ...
                        {{ form_dropdown('partners_personal_history[licensure-month-taken][]',$months_options, $licensure_month_taken, 'class="form-control select2me" data-placeholder="Select..."') }}
                            ...
                            value="<?php echo (isset($licensure['licensure-year-taken']) ? $licensure['licensure-year-taken'] : ""); ?>"placeholder="{{ lang('partners_immediate.enter') }} {{ lang('partners_immediate.date_taken') }}">
                            </span>                            
                        </div>
                </div>
                <div class="form-group">
