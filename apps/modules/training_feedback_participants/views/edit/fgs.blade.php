...
<div class="portlet">
	...
	<div class="portlet-body form">	
		<table class="table">
			...
			<tbody>
				<tr>
					<td>{{ general_date($record['training_feedback.start_date']) }}</td>
					<td>{{ general_time($record['training_feedback.start_time']) }}</td>
					<td>{{ general_time($record['training_feedback.end_time']) }}</td>
