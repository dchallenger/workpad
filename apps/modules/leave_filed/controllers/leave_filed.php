...
class Leave_filed extends MY_PrivateController
{
	public function __construct()
	{
		$this->load->model('leave_filed_model', 'mod');
		parent::__construct();
	}

	public function index($form_id=0, $year='0000')
	{
		...
		$data['year'] = $year;
		$this->load->vars( $data );
		//echo"<pre>";print_r($data['old']);exit;
