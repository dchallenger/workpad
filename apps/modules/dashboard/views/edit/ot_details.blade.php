<div>
    ...
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted small'><?php echo lang('dashboard.ot_from') ?></label>
        <div class='col-md-9'>
            <span class="small"> <?php echo date("F d, Y - h:ia", strtotime($time_from)); ?></span>
        </div>
    </div>
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted small'><?php echo lang('dashboard.ot_to') ?></label>
        <div class='col-md-9'>
            <span class="small"> <?php echo date("F d, Y - h:ia", strtotime($time_to)); ?></span>
        </div>
    </div>
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted small'><?php echo lang('dashboard.ot_hours') ?></label>
        <div class='col-md-9'>
            <span class="small"> <?php echo $hrs; ?></span>
        </div>
    </div>
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted small'><?php echo lang('dashboard.ot_reason') ?></label>
        <div class='col-md-9'>
