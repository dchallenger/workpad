<div>
    ...
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted small'><?php echo lang('dashboard.cws_csched') ?></label>
        <div class='col-md-9'>
            <span class="small"> <?php echo $curr_shift; ?></span>
        </div>
    </div>
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted small'><?php echo lang('dashboard.cws_nsched') ?></label>
        <div class='col-md-9'>
            <span class="small"> <?php echo $to_shift; ?></span>
        </div>
    </div>
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted small'><?php echo lang('dashboard.cws_date') ?></label>
        <div class='col-md-9'>
            <span class="small"> <?php echo date("F d, Y", strtotime($date)); ?></span>
        </div>
    </div>
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted small'><?php echo lang('dashboard.cws_reason') ?></label>
        <div class='col-md-9'>
