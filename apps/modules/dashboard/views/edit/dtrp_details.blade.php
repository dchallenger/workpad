<div>
    ...
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted small'><?php echo lang('dashboard.dtrp_in') ?></label>
        <div class='col-md-9'>
    ...
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted small'><?php echo lang('dashboard.dtrp_out') ?></label>
        <div class='col-md-9'>
    ...
    <?php } ?>
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted small'><?php echo lang('dashboard.date_applied') ?></label>
        <div class='col-md-9'>
            <span class="small"> <?php echo date("F d, Y - h:ia", strtotime($created_on)); ?></span>
        </div>
    </div>    
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted small'><?php echo lang('dashboard.dtrp_reason') ?></label>
        <div class='col-md-9'>
    ...
    <div>
        <button type='button' data-form-name='{{ $form }}' class='btn btn-success btn-sm approve-pop text-success margin-right-5' data-forms-id='{{ $forms_id }}' data-form-owner='{{ $user_id }}' data-user-name='' data-user-id='{{ $approver_id }}' data-decission='6'><i class='fa fa-thumbs-o-up'></i> <?php echo lang('dashboard.approve_form') ?></button>
        <button type='button' data-form-name='{{ $form }}' class='btn btn-danger btn-sm decline-pop text-danger' data-forms-id='{{ $forms_id }}' data-form-owner='{{ $user_id }}' data-user-name='' data-user-id='{{ $approver_id }}' data-decission='7'><i class='fa fa-thumbs-o-down' ></i> <?php echo lang('dashboard.decline_form') ?></button>
