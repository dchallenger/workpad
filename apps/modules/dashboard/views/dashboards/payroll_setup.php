		...
		<div class="col-md-12">
			<div class="portlet">
				...
				<div class="portlet-body note">
					...
					<!-- [5] Previous employer alphalist -->
					<div>
						<div class="col-md-9 margin-bottom-10">
							<h4><?php echo lang('dashboard.previous_employer_alphalist') ?></h4>
							<div class="text-muted small"><?php echo lang('dashboard.previous_employer_alphalist') ?></div>
						</div>
						<div class="col-md-3 margin-bottom-25">
							<a class="btn btn-default" type="button" href="{{ get_mod_route('previous_employer_amount_for_alphalist') }}"><?php echo lang('dashboard.view_list_button') ?></a>
						</div>
						<div class="clearfix"></div>
					</div>					
				</div>
