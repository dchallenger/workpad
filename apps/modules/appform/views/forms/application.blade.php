...
<div class="form-group">
    ...
    <div class="col-md-9">
        <div class="input-icon">
            <input type="text" class="form-control" maxlength="64" name="recruitment_personal[how_hiring_heard]" id="recruitment-firstname">
        </div>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-md-9">
        <div class="input-icon">
            <input type="text" class="form-control" maxlength="64" name="recruitment_personal[referred_by]" id="recruitment-firstname">
        </div>
    </div>
</div>
<div class="form-group">
