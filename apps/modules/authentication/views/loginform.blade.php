...
<head>
	<meta charset="utf-8" />
	<title>{{ $system['application_title'] }} {{ lang('authentication.titlelogin') }}</title>
...
<body class="login">
	...
	<div class="content">
		...
		<div id="loader" class="text-center" style="background-color:#fff; padding: 15px; display:none"><img src="{{ theme_path() }}img/ajax-loader.gif" alt="loading..." /><br/>{{ lang('authentication.signingin') }}</div>
