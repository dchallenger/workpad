                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        ?>
                                            ...
                                            <input type="text" class="form-control" name="partners_personal_history[accountabilities-date-issued]" id="partners_personal_history-accountabilities-date-issued" value="<?php echo (isset($details['accountabilities-date-issued']) ? $details['accountabilities-date-issued'] : ''); ?>" placeholder="Enter Date Issued" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        ?>
                                            <div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
                                            <input type="text" class="form-control" name="partners_personal_history[accountabilities-date-returned]" id="partners_personal_history-accountabilities-date-returned" value="<?php echo (isset($details['accountabilities-date-returned']) ? $details['accountabilities-date-returned'] : ''); ?>" placeholder="Enter Date Returned" >
                                                <span class="input-group-btn">
                                                <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                                </span>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <input type="hidden" name="partners_personal_history[accountabilities-attachment]" id="partners_personal_history-accountabilities-attachment" value="<?php echo (isset($details['accountabilities-attachment']) ? $details['accountabilities-attachment'] : ""); ?>"/>
                                            <div class="input-group">
                                                ...
                                                <ul class="padding-none margin-top-11">
                                                    ...
                                                    <span class="fileupload-preview">
                                                        ...
                                                        <?php
                                                        $attachment_file = (isset($details['accountabilities-attachment']) ? $details['accountabilities-attachment'] : ""); 
