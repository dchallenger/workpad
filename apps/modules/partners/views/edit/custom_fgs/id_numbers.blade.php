        ...
        <div class="form-horizontal">
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ $partners_labels['sss_number'] }}</label>
                    <div class="col-md-5">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ $partners_labels['pagibig_number'] }}</label>
                    <div class="col-md-5">
                ...
                @if(in_array('philhealth_number', $partners_keys))
                    <div class="form-group">
                        <label class="control-label col-md-3">{{ $partners_labels['philhealth_number'] }}</label>
                        <div class="col-md-5">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ $partners_labels['tin_number'] }}</label>
                    <div class="col-md-5">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ $partners_labels['bank_account_number_savings'] }}</label>
                    <div class="col-md-5">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ $partners_labels['bank_account_number_current'] }}</label>
                    <div class="col-md-5">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ $partners_labels['payroll_bank_account_number'] }}</label>
                    <div class="col-md-5">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ $partners_labels['payroll_bank_name'] }}</label>
                    <div class="col-md-5">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ $partners_labels['bank_account_name'] }}</label>
                    <div class="col-md-5">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ $partners_labels['health_care'] }}</label>
                    <div class="col-md-5">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ $partners_labels['drivers_license_no'] }}</label>
                    <div class="col-md-5">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ $partners_labels['passport_no'] }}</label>
                    <div class="col-md-5">
