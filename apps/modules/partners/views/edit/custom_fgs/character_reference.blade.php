		...
		<!-- START FORM -->	
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        value="<?php echo (isset($reference['reference-years-known']) ? $reference['reference-years-known'] : ""); ?>" placeholder="{{ lang('common.enter') }} {{ lang('partners.years_known') }}"/>
                    </div>
                </div>
                <div class="form-group hidden-sm hidden-xs">
                    ...
                    <div class="col-md-6">
                        ...
                        value="<?php echo (isset($reference['reference-phone']) ? $reference['reference-phone'] : ""); ?>" placeholder="{{ lang('common.enter') }} {{ lang('partners.phone') }} {{ lang('partners.number') }}"/>
                         </div>
                    </div>
                </div>
                <div class="form-group hidden-sm hidden-xs">
                    ...
                    <div class="col-md-6">
                        ...
                        value="<?php echo (isset($reference['reference-mobile']) ? $reference['reference-mobile'] : ""); ?>" placeholder="{{ lang('common.enter') }} {{ lang('partners.mobile') }} {{ lang('partners.number') }}"/>
                         </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        value="<?php echo (isset($reference['reference-city']) ? $reference['reference-city'] : ""); ?>" placeholder="{{ lang('common.enter') }} {{ lang('partners.city') }}"/>
                         </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        value="<?php echo (isset($reference['reference-country']) ? $reference['reference-country'] : ""); ?>" placeholder="{{ lang('common.enter') }} {{ lang('partners.country') }}"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
