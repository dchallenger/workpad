	...
	<div class="portlet-body form">
        ...
        <div class="form-horizontal" >
			<div class="form-body">
                        ...
                        <div class="input-group">
                            ...
                            ?>
                                <option value="{{$option->employment_status_id}}" data-active="{{$option->active}}"
                                    @if ($record['partners.status_id'] == $option->employment_status_id)
                                    {{$selected}}
                                    @endif >
                ...
                <div class="form-group hidden resigned_date">
                    ...
                    <div class="col-md-5">
                        <div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
                            <input type="text" class="form-control" name="partners[resigned_date]" id="partners-resigned_date" value="{{ $record['partners.resigned_date'] }}" placeholder="{{ lang('common.enter') }} {{ lang('partners.end_date') }}" >
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ lang('partners.rank') }}</label>
                    <div class="col-md-5">
                ...
                @endif                
                <div class="form-group">
                    <label class="control-label col-md-3">{{ lang('partners.level') }}<span class="required">*</span></label>
                    <div class="col-md-5">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ lang('partners.career_steam') }}</label>
                    <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <?php   $db->select('classification_id,classification');
                                ...
                                $partners_classification_id_options = array('' => 'Select...');
                                foreach($options->result() as $option)
                                {
                        ...
                        {{ form_dropdown('partners[classification_id]',$partners_classification_id_options, $record['partners.classification_id'], 'class="form-control select2me" data-placeholder="Select..."') }}
                        </div>
                    </div>  
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                   		<div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
                            <input type="text" class="form-control" name="partners[employment_end_date]" id="partners-employment_date" value="{{ $record['partners.employment_end_date'] }}" placeholder="{{ lang('common.enter') }} {{ $partners_labels['probationary_date'] }}" >
                            <span class="input-group-btn">
                            <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                            </span>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
                            ...
                            <?php } else { ?>
                                <input type="text" class="form-control" name="partners[regularization_date]" id="partners-regularization_date" value="{{ $record['partners.regularization_date'] }}" placeholder="{{ lang('common.enter') }} {{ lang('partners.regularization_date') }}" >
                            <?php } ?>
                            <span class="input-group-btn">
                            <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                            </span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                   		<div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
                            <input type="text" class="form-control" name="partners[original_hired_date]" id="partners-original_hired_date" value="{{ $record['partners.original_hired_date'] }}" placeholder="{{ lang('common.enter') }} {{ lang('partners.ohire_date') }}" >
                            <span class="input-group-btn">
                            <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                            </span>
                        </div>
