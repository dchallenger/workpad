<div class="portlet">
	<div class="portlet-title">
		<div class="caption" id="education-category">{{ lang('partners.skills') }}</div>
		<div class="actions">
	...
	<div class="portlet-body form">
		...
		<!-- START FORM -->
               <div class="form-group">
                    <label class="control-label col-md-3">{{ lang('partners.skills_type') }}</label>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">{{ lang('partners.skills_name') }}</label>
                    <div class="col-md-6">
