		...
		<!-- START FORM -->
               <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        value="<?php echo (isset($affiliation['affiliation-name']) ? $affiliation['affiliation-name'] : ""); ?>" placeholder="{{ lang('common.enter') }} {{ lang('partners.affiliation_name') }}"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        value="<?php echo (isset($affiliation['affiliation-position']) ? $affiliation['affiliation-position'] : ""); ?>" placeholder="{{ lang('common.enter') }} {{ lang('partners.position') }}"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        {{ form_dropdown('partners_personal_history[affiliation-month-end][]',$months_options, $affiliation_month_end, 'class="form-control select2me" data-placeholder="Select..."') }}
                            ...
                            value="<?php echo (isset($affiliation['affiliation-year-end']) ? $affiliation['affiliation-year-end'] : ""); ?>"placeholder="{{ lang('partners.year') }}" data-inputmask="'mask': '9999'">
                            </span>                            
                        </div>
                </div>
