    		...
    		<!-- START FORM -->	
    				<div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            value="<?php echo (isset($education['education-school']) ? $education['education-school'] : ""); ?>" placeholder="{{ lang('common.enter') }} {{ lang('partners.school') }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            value="<?php echo (isset($education['education-year-from']) ? $education['education-year-from'] : ""); ?>" placeholder="{{ lang('common.enter') }} {{ lang('partners.start_year') }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            value="<?php echo (isset($education['education-year-to']) ? $education['education-year-to'] : ""); ?>" placeholder="{{ lang('common.enter') }} {{ lang('partners.end_year') }}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            value="<?php echo (isset($education['education-degree']) ? $education['education-degree'] : ""); ?>" placeholder="{{ lang('common.enter') }} {{ lang('partners.degree') }}"/>
                        </div>
                    </div>
                    <?php 
                    }else{
