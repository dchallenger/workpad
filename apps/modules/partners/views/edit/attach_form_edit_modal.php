                        ...
                        <div class="form-horizontal">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" maxlength="25" name="partners_personal_history[attachment-name]" id="partners_personal_history-attachment-name" value ="<?php echo (isset($details['attachment-name']) ? $details['attachment-name'] : ""); ?>" placeholder="Enter File Name">
                                    </div>
                                </div>
                                <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">                          
                                        <div data-provides="fileupload" class="fileupload fileupload-new" id="partners_personal_history-file-container">
                                            <input type="hidden" name="partners_personal_history[attachment-file]" id="partners_personal_history-file" value="<?php echo (isset($details['attachment-file']) ? $details['attachment-file'] : ""); ?>"/>
