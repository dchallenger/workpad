...
@section('page-header')
	<div class="row">
		<div class="col-md-12">
			...
			<h3 class="page-title">
				{{ lang('partners.partners') }} <small>{{ lang('partners.manage_partners') }}</small>
			</h3>
				...
				<div class="row">
					...
					<div class="col-md-2 col-sm-4">
						<ul class="list-unstyled profile-nav">
							<li>
								<img src="{{base_url($record['users_profile.photo'])}}" class="img-responsive" alt="" style="width:180px;" /> 
					...
					<div class="col-md-6 col-sm-8">
						<h4 id="position-name">{{$record['users_position.position']}}</h4>
						...
						<ul class="list-inline text-muted margin-bottom-10">
							<li><i class="fa fa-envelope"></i> <span id="email"> {{$record['users.email']}}</span></li>
						</ul>
							...
							<div class="portlet-body">
								<ul class="list-unstyled">
									...
									<li>
										...
										<span class="pull-right" id="birthday"> {{$record['users_profile.birth_date']}}</span>
										<br />
        			...
        			<div class="col-md-12">
        				<div class="tabbable tabbable-custom tabbable-full-width">
        					<ul class="nav nav-tabs">
        						...
        						<li class="">
        							<a data-toggle="tab" href="#profile_tab_3">{{ lang('partners.signatories') }}</a>
        						</li>
        					</ul>
        					<div class="tab-content">
        						<!-- OVERVIEW -->
        						<div id="profile_tab_1" class="tab-pane active">
        							@include('tabs/partners_edit_profile_overview')
        						</div>
        						<!-- HISTORY -->
        						<div id="profile_tab_2" class="tab-pane">
        							@include('tabs/partners_edit_profile_history')
        						</div>
        						<div id="profile_tab_3" class="tab-pane ">
        							@include('tabs/partners_edit_profile_signatory')
        						</div>
        					</div>
        				</div>
        			</div>
...
<script src="{{ theme_path() }}scripts/form-components.js"></script>   
	<script type="text/javascript" src="{{ theme_path() }}modules/partners/edit_custom.js"></script>   
@stop
