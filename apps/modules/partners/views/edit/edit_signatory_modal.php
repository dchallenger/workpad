                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                               ...
                               <!--  <select name="approver_id" id="approver_id" class="form-control select2me" data-placeholder="Select..." id="approver_id">
                                    <option value=""></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                    <div class="make-switch switch-sm" data-on-label="&nbsp;Yes&nbsp;" data-off-label="&nbsp;No&nbsp;">
                                        ...
                                        <input id="approver" type="hidden" name="approver" value="<?php if( $signatory->approver ){ echo '1'; }else{ echo '0'; }  ?>">
                                    </div>
                                <div class="help-block small">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                    <div class="make-switch switch-sm" data-on-label="&nbsp;Yes&nbsp;" data-off-label="&nbsp;No&nbsp;">
                                        ...
                                        <input id="email-val" type="hidden" name="email" value="<?php if( $signatory->email ){ echo '1'; }else{ echo '0'; }  ?>">
                                    </div>
                                <div class="help-block small">
