        ...
        <div class="form-horizontal" >
			<div class="form-body">
            	<div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="hidden" value="1" name="users[active]" >
                        <input type="hidden" value="1" name="rehire" >
                    	<?php	$db->select('company_id,company,company_code');
                    			$db->where('deleted', '0');
                    			...
                    			foreach($options->result() as $option)
                    			{
                                    ...
                                    if($record['users_profile.company_id'] == $option->company_id){
	                    ...
	                    {{ form_dropdown('users_profile[company_id]',$users_profile_company_options, $record['users_profile.company_id'], 'class="form-control select2me" data-placeholder="Select..." id="users_profile-company_id"') }}
	                    </div>
	                </div>
                </div>
                <div class="form-group">
