...
ww_partners.old_new as "partners.old_new", 
valid_date(ww_partners.effectivity_date) as "partners.effectivity_date", 
valid_date(ww_partners.regularization_date) as "partners.regularization_date",
valid_date(ww_partners.last_promotion_date) as "partners.last_promotion_date", 
valid_date(ww_partners.resigned_date) as "partners.resigned_date", 
valid_date(ww_partners.original_hired_date) as "partners.original_hired_date", 
valid_date(ww_partners.employment_end_date) as "partners.employment_end_date", 
...
ww_users_profile.sbu_unit_id as "users_profile.sbu_unit_id",
ww_users_profile.sbu_unit as "users_profile.sbu_unit",
ww_users_profile.sbu_unit_details as "users_profile.sbu_unit_details",
...
ww_users_profile.operational_sbu as "users_profile.operational_sbu",
DATE_FORMAT(ww_users_profile.start_date, \'%M %d, %Y\') as "users_profile.start_date", 
DATE_FORMAT(ww_users_profile.end_date, \'%M %d, %Y\') as "users_profile.end_date", 
