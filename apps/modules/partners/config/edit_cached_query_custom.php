...
DATE_FORMAT(ww_partners.original_hired_date, \'%M %d, %Y\') as "partners.original_hired_date", 
DATE_FORMAT(ww_partners.employment_end_date, \'%M %d, %Y\') as "partners.employment_end_date", 
