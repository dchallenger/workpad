        ...
        <div class="portlet" id="editform" style="display: block;">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">{{ lang('company.company_information') }} <small class="text-muted">{{ lang('company.edit') }}</small>
                    </div>
                    ...
                    <!-- BEGIN FORM-->
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="form-control" maxlength="64" name="users_company[company]" id="maxlength_defaultconfig" placeholder="{{ lang('company.p_company') }}" value="{{{ $record['users_company.company'] }}}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" maxlength="16" name="users_company[company_code]" id="maxlength_defaultconfig" placeholder="{{ lang('company.p_company_code') }}" value="{{{ $record['users_company.company_code'] }}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" maxlength="128" name="users_company[address]" id="maxlength_defaultconfig" placeholder="{{ lang('company.p_address') }}" value="{{ $record['users_company.address'] }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            ...
                                            {{ form_dropdown('users_company[city_id]',$users_company_city_id_options, $record['users_company.city_id'], 'class="form-control select2me" data-placeholder="Select..."') }}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            ...
                                            {{ form_dropdown('users_company[country_id]',$users_company_country_id_options, $record['users_company.country_id'], 'class="form-control select2me" data-placeholder="Select..."') }}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" maxlength="16" name="users_company[zipcode]" id="maxlength_defaultconfig" placeholder="{{ lang('company.p_zipcode') }}" value="{{ $record['users_company.zipcode'] }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">{{ lang('company.vat_registration') }}</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" maxlength="32" name="users_company[vat]" id="maxlength_defaultconfig" placeholder="{{ lang('company.p_vat_registration') }}" value="{{ $record['users_company.vat'] }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">{{ lang('company.rdo_code') }}</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" maxlength="32" name="users_company[rdo]" id="maxlength_defaultconfig" placeholder="{{ lang('company.p_rdo_code') }}" value="{{ $record['users_company.rdo'] }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">{{ lang('company.sss_number') }}</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" maxlength="32" name="users_company[sss]" id="maxlength_defaultconfig" placeholder="{{ lang('company.p_sss_number') }}" value="{{ $record['users_company.sss'] }}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" maxlength="32" name="users_company[sss_branch_code_locator]" id="maxlength_defaultconfig" placeholder="Enter SSS Branch Code Locator" value="{{ $record['users_company.sss_branch_code_locator'] }}">
                                </div>
                            </div>                                                                                     
                            <div class="form-group">
                                <label class="control-label col-md-3">{{ lang('company.pagibig_number') }}</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" maxlength="32" name="users_company[hdmf]" id="maxlength_defaultconfig" placeholder="{{ lang('company.p_pagibig_number') }}" value="{{ $record['users_company.hdmf'] }}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" maxlength="32" name="users_company[phic]" id="maxlength_defaultconfig" placeholder="{{ lang('company.p_philhealth_number') }}" value="{{ $record['users_company.phic'] }}">
                                </div>
                            </div>
                    </div>
            </div>
                                ...
                                <div class="col-md-5">
                                    <div id="">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" maxlength="16" id="company_contacts[]" id="maxlength_defaultconfig" placeholder="{{ lang('company.p_phone') }}">
                                ...
                                <div class="col-md-5">
                                    <div id="">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" maxlength="16" id="company_contacts[]" id="maxlength_defaultconfig" placeholder="{{ lang('company.mobile') }}">
                                            <div class="input-group-btn">
                                                <button type="button" class="btn btn-default">
                                                    <i class="fa fa-trash-o"></i> 
                                                </button>
                                ...
                                <div class="col-md-5">
                                    <div id="">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" maxlength="16" id="company_contacts[]" id="maxlength_defaultconfig" placeholder="{{ lang('company.p_fax_no') }}">
                                            <div class="input-group-btn">
                                                <button type="button" class="btn btn-default">
                                                    <i class="fa fa-trash-o"></i> 
                                                </button>
                                    ...
                                    <div class="col-md-9">
                                        <div class="fileupload fileupload-new" data-provides="fileupload" id="headerlogo-photo-container">
                                            ...
                                            <div id="header_logo-photo-container">
                                                ...
                                                <span class="fileupload-new"><i class="fa fa-paper-clip"></i> {{ lang('company.select_image') }}</span>
                                                <span class="fileupload-exists"><i class="fa fa-undo"></i> {{ lang('company.change') }}</span>
                                                <input type="file" name="files[]" class="default file" id="config-general-header_logo" />
                                                </span>
                                                <a href="#" class="btn red fileupload-exists fileupload-delete" data-dismiss="fileupload"><i class="fa fa-trash-o"></i> {{ lang('company.remove') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <button 
                                            ...
                                            type="button" 
                                            onclick="save_record( $(this).closest('form'), '')"><i class="fa fa-check"></i> {{ lang('company.save') }}
                                        </button>
                                        <button class="btn blue btn-sm" type="submit" onclick="save_record( $(this).parents('form'), 'new')">{{ lang('company.save') }} &amp; {{ lang('company.add_new') }}</button>
                                        <a href="{{ $mod->url }}" class="btn default btn-sm">{{ lang('company.back') }}</a> 
                                    </div>
                                </div>
                            </div>
                        </div>
