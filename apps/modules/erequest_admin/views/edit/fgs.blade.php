<div class="portlet">
	...
	<div class="portlet-body form">			
		...
		<div class="form-group">
			...
			<div class="col-md-7">							
				<textarea disabled class="form-control" name="resources_request[reason]" id="resources_request-reason" placeholder="{{ lang('common.enter') }} {{ lang('erequest_admin.reason') }}" rows="4">{{ $record['resources_request.reason'] }}</textarea> 				
			</div>	
		</div>			
		<div class="form-group">
