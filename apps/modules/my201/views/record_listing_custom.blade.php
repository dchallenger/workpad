...
@section('page_styles')
	...
	<link rel="stylesheet" type="text/css" href="{{ theme_path() }}plugins/jquery-tags-input/jquery.tagsinput.modal.css" />
							...
							<div class="portlet-body">
								<ul class="list-unstyled">
									...
									<li>
										...
										<!-- <a href="{{ get_mod_route('profile') }}" class="btn icn-only btn-info">{{ lang('my201.my_profile') }} <i class="m-icon-swapright m-icon-white"></i></a> -->
			                        </li>
								</ul>
							</div>
						</div>
						...
						<div class="tabbable tabbable-custom tabbable-full-width">
							...
							<div class="tab-content">
								...
								<div id="profile_tab_1" class="tab-pane active">
									@include('tabs/my_account_profile_overview')
								</div>
								<!-- HISTORY -->
								<div id="profile_tab_2" class="tab-pane">
									@include('tabs/my_account_profile_history')
								</div>
							</div>
						</div>
					</div>
...
@section('page_plugins')
	...
	<script src="{{ theme_path() }}plugins/jquery-tags-input/jquery.tagsinput.min.js" type="text/javascript" ></script>
...
@section('page_scripts')
    ...
    <script src="{{ theme_path() }}modules/my201/lists.js"></script>      
	@stop
