	...
	<div class="row">
		...
		<div class="tab-content col-lg-9 col-md-8">
			<div class="tab-pane active" id="historical_tab1">
				...
				<div class="portlet">
					<div class="portlet-title">
						<div class="caption" id="education-type[1]"><?php echo (isset($education['education-type']) ? $education['education-type'] : ""); ?></div>
						<div class="tools">
					...
					<div class="portlet-body form">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 text-right text-muted">{{ lang('my201.honors_receive') }} :</label>
									<div class="col-md-7 col-sm-7">
										<span id="education-degree[1]"><?php echo (isset($education['education-honors_awards']) ? $education['education-honors_awards'] : ""); ?></span>
									</div>
								</div>
							</div>
						</div>                 
				...
				<div class="portlet">
					...
					<div class="portlet-body form">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 text-right text-muted">{{ lang('my201.training_provider') }} :</label>
									<div class="col-md-7 col-sm-7">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 text-right text-muted">{{ lang('my201.training_cost') }} :</label>
									<div class="col-md-7 col-sm-7">
				...
				<table class="table table-condensed table-striped table-hover">
					...
					<tbody id="movement-list">
						...
						<tr class="record">
							...
							<td>
								<?php echo date('F d, Y H:ia', strtotime($da['created_on'])); ?>
							</td>
						</tr>
						<?php $ctr++; } ?>
					</tbody>
