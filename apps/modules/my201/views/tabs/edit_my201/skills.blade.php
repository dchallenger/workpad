	...
	<div class="portlet-body form">
		...
		<!-- START FORM -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea rows="3" class="form-control" {{ ($is_editable['skill-remarks'] == 1) ? '' : 'readonly="readonly"' }} name="partners_personal_history[skill-remarks][]" id="partners_personal_history-skill-remarks" ><?php echo (isset($skill['skill-remarks']) ? $skill['skill-remarks'] : ""); ?></textarea>
                    </div>
                </div>
                @endif
			</div>
