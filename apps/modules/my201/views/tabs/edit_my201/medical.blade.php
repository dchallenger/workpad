		...
		<!-- START FORM -->
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <?php $disabled = ($is_editable['medical-exam-type'] == 1) ? '' : 'disabled';?>
                        {{ form_dropdown('partners_personal_history[medical-exam-type][]',$partners_medical_exam_type_options, $medical['medical-exam-type'], 'class="form-control select2me" '.$disabled.' data-placeholder="Select..."') }}
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        @if ($is_editable['medical-date-exam'] == 1)
                        ...
                        @else
                            <input type="text" {{ ($is_editable['medical-date-exam'] == 1) ? '' : 'readonly="readonly"' }} class="form-control" name="partners_personal_history[medical-date-exam][]" id="partners-medical-date-exam" value="{{(isset($medical['medical-date-exam']) ? $medical['medical-date-exam'] : "")}}">
                        @endif
                    </div>
                </div>                        
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" {{ ($is_editable['medical-clinic-hospital'] == 1) ? '' : 'readonly="readonly"' }} class="form-control" name="partners_personal_history[medical-clinic-hospital][]" id="partners_personal_history-medical-clinic-hospital" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" {{ ($is_editable['medical-pre-existing'] == 1) ? '' : 'readonly="readonly"' }} class="form-control" name="partners_personal_history[medical-pre-existing][]" id="partners_personal_history-medical-pre-existing" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea rows="3" {{ ($is_editable['medical-findings'] == 1) ? '' : 'readonly="readonly"' }} class="form-control" name="partners_personal_history[medical-findings][]" id="partners_personal_history-medical-findings" ><?php echo (isset($medical['medical-findings']) ? $medical['medical-findings'] : ""); ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">{{ lang('partners.medical_status') }}</label>
                    <div class="col-md-6">
                        <input type="text" {{ ($is_editable['medical-status'] == 1) ? '' : 'readonly="readonly"' }} class="form-control" name="partners_personal_history[medical-status][]" id="partners_personal_history-medical-status" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" {{ ($is_editable['medical-cost'] == 1) ? '' : 'readonly="readonly"' }} class="form-control" name="partners_personal_history[medical-cost][]" id="partners_personal_history-medical-cost" 
