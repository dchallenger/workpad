...
<div class="portlet">
	<div class="portlet-title">
	    ...
	    @if(in_array('affiliation-name', $partners_keys))
	        @if($is_editable['affiliation-name'])
	        <?php $editable = true?>
			<div class="actions">
		...
		<!-- START FORM -->
				@if(in_array('affiliation-name', $partners_keys))
	               	<div class="form-group">
	                    ...
	                    <div class="col-md-6">
	                        ...
	                        value="<?php echo (isset($affiliation['affiliation-name']) ? $affiliation['affiliation-name'] : ""); ?>" placeholder="{{ lang('common.enter') }} {{ lang('my201.affiliation_name') }}"/>
	                    </div>
	                </div>
	            @endif
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        value="<?php echo (isset($affiliation['affiliation-year-end']) ? $affiliation['affiliation-year-end'] : ""); ?>"placeholder="{{ lang('my201.year') }}">
                        </span> 
                        @endif                           
                    </div>
                </div>
