            ...
            @if($editable)
                <div class="portlet-title">
                    <div class="caption" id="test-category">
                        ...
                        <?php echo (isset($test['test-category']) ? $test['test-category'] : ""); ?>
                    </div>
                    <div class="tools">
                ...
                <div class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" {{ ($is_editable['test-title'] == 1) ? '' : 'readonly="readonly"' }} class="form-control" name="partners_personal_history[test-title][]" id="partners_personal_history-test-title" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                @if($is_editable['test-date-taken'] == 1)
                                ...
                                @else
                                    <input type="text" {{ ($is_editable['test-date-taken'] == 1) ? '' : 'readonly="readonly"' }} class="form-control" name="partners_personal_history[test-date-taken][]" id="partners_personal_history-test-date-taken"
                                    value="<?php echo (isset($test['test-date-taken']) ? $test['test-date-taken'] : ""); ?>">
                                @endif
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" {{ ($is_editable['test-location'] == 1) ? '' : 'readonly="readonly"' }} class="form-control" name="partners_personal_history[test-location][]" id="partners_personal_history-test-location" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" {{ ($is_editable['test-score'] == 1) ? '' : 'readonly="readonly"' }} class="form-control" name="partners_personal_history[test-score][]" id="partners_personal_history-test-score" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="make-switch" data-on="success" data-off="danger" data-on-label="&nbsp;Passed&nbsp;" data-off-label="&nbsp;Failed&nbsp;">
                                    ...
                                    <input type="checkbox" {{ ($is_editable['test-score'] == 1) ? '' : 'disabled' }} value="1" @if( $testresult ) checked="checked" @endif name="partners_personal_history[test-result][temp][]" id="partners_personal_history-test-result-temp" class="dontserializeme toggle exam_result"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea rows="3" {{ ($is_editable['test-remarks'] == 1) ? '' : 'readonly="readonly"' }} class="form-control"name="partners_personal_history[test-remarks][]" id="partners_personal_history-test-remarks" ><?php echo (isset($test['test-remarks']) ? $test['test-remarks'] : ""); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
