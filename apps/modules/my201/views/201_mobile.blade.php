...
@foreach($education_tab as $index => $education)
	<li class="in2">
		<div class="profile-block">
			...
			<div class="profile-info">
				<?php echo (isset($education['education-type']) ? $education['education-type'] : ""); ?>
			</div>
		</div>
	</li>
	<li class="in2">
		<div class="profile-block">
			...
			<div class="profile-info">
				<?php echo (isset($education['education-degree']) ? $education['education-degree'] : ""); ?>
			</div>
		</div>
	</li>
	<li class="in2">
		<div class="profile-block">
			...
			<div class="profile-info">
				<?php echo (isset($education['education-school']) ? $education['education-school'] : ""; ?>
			</div>
		</div>
	</li>
	<li class="in2 endlist">
		<div class="profile-block">
			...
			<div class="profile-info">
				<?php echo (isset($education['education-year-from']) ? $education['education-year-from'] : ""); ?>-<?php echo (isset($education['education-year-to']) ? $education['education-year-to'] : ""); ?>
			</div>
		</div>
	</li>
@endforeach
