...
`ww_partners_loan_application`.`loan_application_id` as loan_application_id,
ww_users.full_name as full_name,
...
loan_application_status_approver.loan_application_status as approver_status,
loan_application_status_approver.loan_application_status_id as approver_status_id,
ww_partners_loan_type.loan_type_code as "partners_loan_type_code",
ww_partners_loan_type.loan_type as "partners_loan_type",
ww_partners_loan_type.loan_type_id as "partners_loan_type_id",
...
ww_partners_loan_application_approver.user_id as "approver_id",
...
LEFT JOIN `ww_partners_loan_application_approver` ON `ww_partners_loan_application`.`loan_application_id` = `ww_partners_loan_application_approver`.`loan_application_id`
LEFT JOIN `ww_users` ON `ww_partners_loan_application`.`user_id` = `ww_users`.`user_id`
...
LEFT JOIN `ww_partners_loan_application_status` loan_application_status_approver ON `ww_partners_loan_application_approver`.`loan_application_status_id` = `loan_application_status_approver`.`loan_application_status_id`
WHERE (
