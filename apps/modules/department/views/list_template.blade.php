...
<!-- <td class="hidden-xs">
    ...
    <td>
        <a id="users_department_department" href="<?php echo $detail_url; ?>" ><?php echo $users_department_department; ?></a>
        <br>
    ...
    <td>
        <div class="btn-group">
            <a class="btn btn-xs text-muted" href="{{ $edit_url }}"><i class="fa fa-pencil"></i> {{ lang('department.edit') }}</a>
        </div>
        <div class="btn-group">
            <a class="btn btn-xs text-muted" href="#" data-close-others="true" data-toggle="dropdown"><i class="fa fa-gear"></i> {{ lang('department.options') }}</a>
