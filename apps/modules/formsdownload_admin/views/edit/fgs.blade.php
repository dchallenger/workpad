	...
	<div class="portlet-title">
		...
		<div class="portlet-body form">			
			<div class="form-group">
				...
				<div class="col-md-7">							
					<input type="text" class="form-control" name="resources_downloadable[title]" id="resources_downloadable-title" value="{{ $record['resources_downloadable.title'] }}" placeholder="Enter Title" /> 				
				</div>	
			</div>			
			<div class="form-group hidden">
				...
				<div class="col-md-7">
					<?php									                            		
	                    ...
	                    $db->where('deleted', '0');
	                    $options = $db->get('resources_category'); 	                            
	                    $resources_downloadable_category_options = array('' => 'Select...');
		...
		<div class="form-group">
			<label class="control-label col-md-3">{{ lang('formsdownload_admin.company') }}</label>
				<div class="col-md-7">
                    ...
                    <div class="input-group">
						<span class="input-group-addon"><i class="fa fa-list-ul"></i></span>
	                        {{ form_dropdown('resources_downloadable[company_id][]',$resources_policies_company_options, explode(',',$record['resources_downloadable.company_id']), 'class="form-control select2me" multiple="multiple" data-placeholder="Select..." id="resources_policies-company_id"') }}
	                </div>
	            </div>	
		</div>
			<div class="form-group">
				...
				<div class="col-md-7">							
					<textarea class="form-control" name="resources_downloadable[description]" id="resources_downloadable-description" placeholder="Enter Description" rows="4">{{ $record['resources_downloadable.description'] }}</textarea> 				
				</div>	
			</div>			
			<div class="form-group">
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('formsdownload_admin.attachments') }}</label>
				<div class="col-md-7">							
					<div data-provides="fileupload" class="fileupload fileupload-new" id="resources_downloadable-attachments-container">
