<div class="portlet">
	...
	<div class="portlet-body form">			
		<div class="form-group">
			...
			<div class="col-md-7">							
				<input type="text" disabled="disabled" class="form-control" name="partners_employment_status[employment_status]" id="partners_employment_status-employment_status" value="{{ $record['partners_employment_status.employment_status'] }}" placeholder="{{ lang('employment_status.p_employment_status') }}"/> 				
			</div>	
		</div>			
		<div class="form-group">
			...
			<div class="col-md-7">							
				<div class="make-switch" data-on-label="&nbsp;{{ lang('employment_status.option_yes') }}&nbsp;" data-off-label="&nbsp;{{ lang('employment_status.option_no') }}&nbsp;">
			    	<input type="checkbox" disabled="disabled" value="1" @if( $record['partners_employment_status.active'] ) checked="checked" @endif name="partners_employment_status[active][temp]" id="partners_employment_status-active-temp" class="dontserializeme toggle"/>
