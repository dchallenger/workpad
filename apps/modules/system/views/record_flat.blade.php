                ...
                <div class="portlet" style="cursor:pointer">
                    ...
                    <div class="portlet-body form" style="display:none;">
                        ...
                        <form action="#" id="config-other-settings" class="form-horizontal form" name="config-other-settings">
                            ...
                            <hr style="border-style: dashed;" />
                            @if(isset($other_config['appraisal_committee_rating']))
                            <div class="form-group">
                                <label class="control-label col-md-3">{{ lang('system_settings.committee_ratings') }}</label>
                                <div class="col-md-3">
                                    <?php
                                        $user_options = array();                                    
                                    ...
                                    ?>
                                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-list-ul"></i></span>
                                        <?php
                                            $committee_rating_val = array();
/*                                            if (isset($other_config['appraisal_committee_rating']) && $other_config['appraisal_committee_rating'] != '') {
