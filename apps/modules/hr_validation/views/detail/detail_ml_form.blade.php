        ...
        <div class="col-md-9">
				...
				<div id="vl_container" class="portlet">
						<div class="portlet-title">
							<div class="caption">{{ lang('form_application_admin.ml_form') }} <small class="text-muted">{{ lang('common.view') }}</small></div>
						</div>
	                        ...
	                        <!-- BEGIN FORM-->
	                            <div class="form-body">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('form_application_admin.num_preg') }} :</label>
												<div class="col-md-7 col-sm-7">
													@if($record['time_forms_maternity_pregnancy_no']>0)
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('form_application_admin.expected_delivery') }} :</label>
												<div class="col-md-7 col-sm-7">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('form_application_admin.actual_delivery') }} :</label>
												<div class="col-md-7 col-sm-7">
													<span>{{ $record['time_forms_maternity_actual_date'] }} - <?php if(strtotime($record['time_forms_maternity_actual_date'])) echo date('D',strtotime($record['time_forms_maternity_actual_date'])); ?></span>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('form_application_admin.report_date') }} :</label>
												<div class="col-md-7 col-sm-7">
													<span>{{ $record['time_forms_maternity_return_date'] }} - <?php if(strtotime($record['time_forms_maternity_return_date'])) echo date('D',strtotime($record['time_forms_maternity_return_date'])); ?></span>
												</div>
											</div>
										</div>
									</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-offset-4 col-md-8">
                                            	...
                                            	<?php } ?>
	                                        	<a href="{{ $mod->url }}" class="btn btn-default btn-sm">{{ lang('form_application_admin.back_to_list') }}</a>
	                                        </div>
                                        </div>
                                    </div>
                                </div>
