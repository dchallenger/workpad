		...
		<div class="portlet-body form">			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-7"><?php                                                        		$db->select('job_grade_id,job_level');
	                            ...
	                            {{ form_dropdown('time_form_class_policy[job_grade_id][]',$time_form_class_policy_job_grade_id_options, explode(',', $record['time_form_class_policy.job_grade_id']), 'class="form-control" data-placeholder="Select..." multiple="multiple" id="time_form_class_policy-job_grade_id"') }}
	                        </div> 				</div>	
			</div>
			<div class="form-group">
