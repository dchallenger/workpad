		...
		<div class="portlet">
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						@if ($policies)
						<li class=""><a href="{{ get_mod_route('policies_procedures') }}">{{ lang('common.personal') }}</a></li>
						@endif
						@if ($policies_admin)
						<li class="active"><a href="{{ get_mod_route('policies_procedures_admin') }}">{{ lang('common.admin') }}</a></li>
						@endif
					</ul>
				</div>
			</div>
			...
			<div class="portlet-title">
				<div class="caption">
					...
					{{ lang('policies_procedures_admin.pol_proc') }}
				</div>
