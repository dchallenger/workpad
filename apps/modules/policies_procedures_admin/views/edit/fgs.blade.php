<div class="portlet">
	<div class="portlet-title">
		<div class="caption">{{ lang('policies_procedures_admin.pol_proc') }}</div>
		<div class="tools"><a class="collapse" href="javascript:;"></a></div>
	</div>
	<div class="portlet-body form">
		<div class="form-group">
			<label class="control-label col-md-3"><span class="required">* </span>{{ lang('policies_procedures_admin.title') }}</label>
			<div class="col-md-7">
			...
			<label class="control-label col-md-3">{{ lang('policies_procedures_admin.category') }}</label>
				<div class="col-md-7">
					<?php $db->select('category,category');
	                      ...
	                      $resources_policies_category_options = array('' => 'Select...');
		...
		<div class="form-group">
			...
			<div class="col-md-7">
				<textarea class="form-control" name="resources_policies[description]" id="resources_policies-description" placeholder="Enter Description" rows="4">{{ $record['resources_policies.description'] }}</textarea>
			</div>	
		</div>
		<div class="form-group">
			<label class="control-label col-md-3"><span class="required">* </span>{{ lang('policies_procedures_admin.attachments') }}</label>
			<div class="col-md-7">
				<div data-provides="fileupload" class="fileupload fileupload-new" id="resources_policies-attachments-container">
					...
					<div class="input-group">
						...
						<span class="btn default btn-file">
							<span class="fileupload-new"><i class="fa fa-paper-clip"></i> {{ lang('policies_procedures_admin.select_file') }}</span>
				...
				<div class="help-block text-muted">
					Maximum file size to upload : {{ ini_get('upload_max_filesize') }}
				</div>
			</div>
		</div>
	</div>
