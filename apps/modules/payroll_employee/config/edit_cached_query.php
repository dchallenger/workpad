...
$config["edit_cached_query"] = 'SELECT 
	...
	IFNULL(`ww_payroll_partners`.`sss_mode`,1) as "payroll_partners.sss_mode", 
	...
	IFNULL(`ww_payroll_partners`.`hdmf_mode`,1) as "payroll_partners.hdmf_mode", 
	...
	IFNULL(`ww_payroll_partners`.`phic_mode`,1) as "payroll_partners.phic_mode", 
	...
	IFNULL(`ww_payroll_partners`.`tax_mode`,1) as "payroll_partners.tax_mode", 
