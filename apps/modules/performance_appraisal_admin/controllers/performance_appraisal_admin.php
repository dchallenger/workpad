...
/*                $feed = array(
            ...
            case 4: //approved
		        ...
		        if ($approvers && $approvers->num_rows() > 0){
                    ...
                    // email to immediate to inform that appraisal has been approved by the approver
                    $employee = $appraisee->created_by;
                    $sendtargetsettings['recepient'] = $appraisee->immediate;
                    $sendtargetsettings['status'] = 'Approved';

                    $target_settings_send_template = $this->db->get_where( 'system_template', array( 'code' => 'PERFORMANCE-APPRAISAL-SEND-APPROVED-DISAPPROVED') )->row_array();
                    $msg = $this->parser->parse_string($target_settings_send_template['body'], $sendtargetsettings, TRUE); 
                    $subject = $this->parser->parse_string($target_settings_send_template['subject'], $sendtargetsettings, TRUE); 
                ...
                // email to appraisee to inform that appraisal has been approved by the approver
                $employee = $appraisee->user_id;
                $sendtargetsettings['recepient'] = $appraisee->fullname;
                $sendtargetsettings['status'] = 'Approved';
        	...
        	case 1: //disapproved
                ...
                $employee = $appraisee->created_by;
                $sendtargetsettings['recepient'] = $appraisee->immediate;
                $sendtargetsettings['status'] = 'Disapproved';
