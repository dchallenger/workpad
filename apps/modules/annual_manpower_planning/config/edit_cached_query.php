...
`ww_recruitment_manpower_plan`.`manpower_plan_status_id` as "recruitment_manpower_plan.manpower_plan_status_id", 
...
ww_recruitment_manpower_plan.division_id as "recruitment_manpower_plan.division_id",
...
T5.immediate as "recruitment_manpower_plan.divisionhead", 
ww_recruitment_manpower_plan.display_name as "recruitment_manpower_plan.created_by", 
...
LEFT JOIN `ww_users_division` T5 ON T5.division_id = ww_recruitment_manpower_plan.division_id
