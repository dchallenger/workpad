<tr id="filter-<?php echo $column;?>">
	...
	<td>
		<input type="text" class="form-control" name="report_generator_filters[order_by][]" value="<?php echo (isset($order_by) ? $order_by : '') ?>">
	</td>		
	<td>
		<input type="text" class="form-control" name="report_generator_filters[filtering_only][]" value="<?php echo (isset($filtering_only) ? $filtering_only : '') ?>">
	</td>	
	<td>
