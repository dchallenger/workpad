...
<table>
    	...
    	foreach( $emp as $idno => $rows):            
    		foreach( $rows as $value) :
                if($row_count > 32){?>
                    ...
                    <tr>
                        <td style=" width: 12% ; text-align:left  ; ">Total : <?php echo $count; ?></td>
                        <td style=" width: 5% ; text-align:right"><?php echo number_format(  $tBasic ,2,'.',','); ?></td>
                        <td style=" width: 3% ; text-align:right;"><?php echo number_format( $tCola ,2,'.',','); ?></td>
                        <td style=" width: 3% ; text-align:right;"><?php echo number_format( $tND ,2,'.',','); ?></td>
                ...
                if($row_count == 0 ){?>
                    ...
                    <tr> 
                        ...
                        <td style=" width: 8% ; text-align:left;"><strong>&nbsp;</strong></td>
                    ...
                    <tr> 
                        ...
                        <td style=" width: 8% ; text-align:left;"><strong>EMPLOYEE NAME</strong></td>
                        <td style=" width: 5% ; text-align:right;"><strong>BASIC</strong></td>
                        <td style=" width: 3% ; text-align:right;"><strong>COLA</strong></td>
                        <td style=" width: 3% ; text-align:right;"><strong>NDIFF</strong></td>
				...
				<tr>
			        ...
			        <td style=" width: 8% ; text-align:left ; font-size: 6.5;"><?php echo $value{'Full Name'}; ?></td>
			        <td style=" width: 5% ; text-align:right"><?php echo number_format($value{'Basic'},2,'.',','); ?></td>
			        <td style=" width: 3% ; text-align:right;"><?php echo number_format($value{'Cola'},2,'.',','); ?></td>
                    <td style=" width: 3% ; text-align:right;"><?php echo number_format($value{'Nd'},2,'.',','); ?></td>
    ...
    <tr>
        <td style=" width: 12% ; text-align:left  ; ">Grand Total : <?php echo $total_count; ?></td>
        <td style=" width: 5% ; text-align:right"><?php echo number_format( $gtBasic ,2,'.',','); ?></td>
        <td style=" width: 3% ; text-align:right;"><?php echo number_format( $gtCola ,2,'.',','); ?></td>
        <td style=" width: 3% ; text-align:right;"><?php echo number_format( $gtND ,2,'.',','); ?></td>
