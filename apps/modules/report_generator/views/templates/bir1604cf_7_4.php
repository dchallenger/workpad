<?php
    ...
    if (count($result) > 0){
        ...
        $total_prev_nontax_thirten_month = 0;
        $total_prev_nontax_deminimis = 0;
        $total_prev_nontax_sss_etc = 0;
        $total_prev_nontax_salaries = 0;
        $total_prev_nontax_comp_income = 0;
        $total_prev_taxable_basic_salary = 0;
        $total_prev_taxable_thirten_month = 0;
        $total_prev_taxable_salaries = 0;
        $total_prev_total_taxable = 0;
        $total_prev_tax_w_held = 0;
		...
		foreach( $result as $row ){
			if (strtotime($row['Resigned Date']) < strtotime($return_period)) {
		        ...
		        $prev_nontax_thirten_month = 	$row['Prev Nontax 13th Month'];
		        $prev_nontax_deminimis = 		$row['Prev Nontax De Minimis'];
		        $prev_nontax_sss_etc = 			$row['Prev Nontax Sss Etc'];
		        $prev_nontax_salaries = 		$row['Prev Nontax Salaries'];
		        $prev_nontax_comp_income = 		$row['Prev Total Nontax Comp Income'];
		        $prev_taxable_basic_salary = 	$row['Prev Taxable Basic Salary'];
		        $prev_taxable_thirten_month = 	$row['Prev Taxable 13th Month'];
		        $prev_taxable_salaries = 		$row['Prev Taxable Salaries'];
		        $prev_total_taxable = 			$row['Prev Total Taxable'];
		        $prev_tax_w_held = 				$row['Prev Tax Wthld'];
		        ...
		        $pres_total_comp =    			$row['Pres Total Comp'];
		        ...
		        $total_prev_nontax_thirten_month += $prev_nontax_thirten_month;
		        $total_prev_nontax_deminimis += $prev_nontax_deminimis;
		        $total_prev_nontax_sss_etc += $prev_nontax_sss_etc;
		        $total_prev_nontax_salaries += $prev_nontax_salaries;
		        $total_prev_nontax_comp_income += $prev_nontax_comp_income;
		        $total_prev_taxable_basic_salary += $prev_taxable_basic_salary;
		        $total_prev_taxable_thirten_month += $prev_taxable_thirten_month;
		        $total_prev_taxable_salaries += $prev_taxable_salaries;
		        $total_prev_total_taxable += $prev_total_taxable;
		        $total_prev_tax_w_held += $prev_tax_w_held;
		        ...
		        $total_pres_total_comp = $pres_total_comp;
				...
				echo $schedule_num . ',' .
					 ...
					 $gross_compensation . ',' .
					 $prev_nontax_thirten_month . ',' .
					 $prev_nontax_deminimis . ',' .
			         $prev_nontax_sss_etc . ',' .
			         $prev_nontax_salaries . ',' .
			         $prev_nontax_comp_income . ',' .
			         $prev_taxable_basic_salary . ',' .
			         $prev_taxable_thirten_month . ',' .
		...
		echo 'C7.4,' .
	         ...
	         $total_prev_nontax_thirten_month . ',' .
	         $total_prev_nontax_deminimis . ',' .
	         $total_prev_nontax_sss_etc . ',' .
	         $total_prev_nontax_salaries . ',' .
	         $total_prev_nontax_comp_income . ',' .
	         $total_prev_taxable_basic_salary . ',' .
	         $total_prev_taxable_thirten_month . ',' .
	         $total_prev_taxable_salaries . ',' .
	         $total_prev_total_taxable . ',' .
