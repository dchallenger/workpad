<div class="portlet">
	...
	<div class="portlet-body form">			
		<div class="form-group">
			...
			<div class="col-md-7">
				<?php
					$options = $db->query(str_replace('{dbprefix}', $db->dbprefix, "SELECT a.transaction_id, a.transaction_label, b.transaction_class
					...
					$payroll_bonus_bonus_transaction_id_options = array('' => 'Select...');
				...
				<div class="input-group">
					...
					{{ form_dropdown('payroll_bonus[bonus_transaction_id]',$payroll_bonus_bonus_transaction_id_options, $record['payroll_bonus.bonus_transaction_id'], 'class="form-control select2me" data-placeholder="Select..." disabled') }}
                </div>
            </div>	
		</div>			
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-7">							
				<input type="hidden" name="payroll_bonus[date]"/>
				<div class="input-group input-xlarge" data-date-format="MM dd, yyyy">
					<input type="text" class="form-control" name="payroll_bonus[date_from]" id="payroll_bonus-date_from" value="{{ $record['payroll_bonus.date_from'] }}" readonly/>
					<span class="input-group-addon">to</span>
					<input type="text" class="form-control" name="payroll_bonus[date_to]" id="payroll_bonus-date_to" value="{{ $record['payroll_bonus.date_to'] }}" readonly/>
				</div>
			</div>	
		</div>			
		<div class="form-group hidden">
			...
			<div class="col-md-7">							
				<input type="text" class="form-control" name="payroll_bonus[period]" id="payroll_bonus-period" value="{{ $record['payroll_bonus.period'] }}" placeholder="Enter No. of Periods" data-inputmask="'alias': 'decimal', 'autoGroup': true, 'groupSeparator': ',', 'groupSize': 3, 'repeat': 13, 'greedy' : false"/>
			</div>	
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-7">
				<?php
					$db->select('payroll_transaction_method_bonus_id,payroll_transaction_method_bonus');
                    $db->order_by('payroll_transaction_method_bonus', '0');
                    $db->where('deleted', '0');
                    $options = $db->get('payroll_transaction_method_bonus');
                    $payroll_bonus_transaction_method_id_options = array('' => 'Select...');
                    foreach($options->result() as $option) {
                ...
                <div class="input-group">
					<span class="input-group-addon"><i class="fa fa-list-ul"></i></span>
                    {{ form_dropdown('payroll_bonus[transaction_method_id]',$payroll_bonus_transaction_method_id_options, $record['payroll_bonus.transaction_method_id'], 'class="form-control select2me method" data-placeholder="Select..." disabled') }}
                </div>
            </div>	
		</div>
		<div class="form-group">
			...
			<div class="col-md-7">
				<?php
					...
					$payroll_bonus_account_id_options = array('' => 'Select...');
                    foreach($options->result() as $option) {
                ...
                <div class="input-group">
					<span class="input-group-addon"><i class="fa fa-list-ul"></i></span>
                    {{ form_dropdown('payroll_bonus[account_id]',$payroll_bonus_account_id_options, $record['payroll_bonus.account_id'], 'class="form-control select2me" data-placeholder="Select..." disabled') }}
                </div>
            </div>	
		</div>
		<div class="form-group">
			...
			<div class="col-md-7">
				<textarea class="form-control" name="payroll_bonus[description]" id="payroll_bonus-description" placeholder="Enter Description" rows="4" readonly>{{ $record['payroll_bonus.description'] }}</textarea>
			</div>	
		</div>	
	</div>
</div>
<div class="portlet">
    ...
    <div class="portlet margin-top-25">
		<h5 class="form-section margin-bottom-10"><b>List of Employee</b></h5>

        <div class="portlet-body" >
        	<table class="table table-condensed table-striped table-hover" >
                <thead>
                    <tr>
                    	<th width="50%" class="padding-top-bottom-10" >Employee</th>
                    	<th width="50%" class="padding-top-bottom-10 amount_header" align="right">Amount</th>
                    </tr> 
                </thead>
