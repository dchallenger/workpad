...
<div class="portlet">
	...
	<div class="portlet-body form">		
		<div class="form-group">
			...
			<div class="col-md-6">
				...
				<div class="input-group">
					...
					{{ form_dropdown('performance_planning[template_id]',$performance_planning_template_id_options, $record['performance_planning.template_id'], 'class="form-control select2" data-placeholder="Select..." id="performance_planning-template_id"') }}
				</div>
			</div>	
		</div>
		...
		<div class="form-group">
			<label class="control-label col-md-4">
				<span class="required">* </span>
				{{ lang('performance_planning.employees') }}
			</label>
			<div class="col-md-6">
				<?php
