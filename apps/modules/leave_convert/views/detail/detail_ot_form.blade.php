        ...
        <div class="col-md-9">
				...
				<div id="vl_container" class="portlet">
						<div class="portlet-title">
							<div class="caption">Overtime Form <small class="text-muted">view</small></div>
						</div>
		                ...
		                <div class="portlet">
							<div class="portlet-title">
								<div class="caption">Leave Convert Details</div>
								<div class="tools">
									<a class="collapse" ></a>
								</div>
							</div>
							<p class="margin-bottom-25">This section contains details of leave conversion.</p>
							...
							<div class="portlet-body">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
		                                    <label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('common.status') }} :</label>
	                                    	<div class="col-md-5 col-sm-6">
													{{ $ot_leave['form_status'] }}
		                                    </div>
		                                </div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
		                                    <label class="control-label col-md-4 col-sm-4 text-right text-muted">Hours Rendered:</label>
	                                    	<div class="col-md-5 col-sm-6">
													{{ $form_approver_details['hrs'] }}
		                                    </div>
		                                </div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
		                                    <label class="control-label col-md-4 col-sm-4 text-right text-muted">Additional Leave Credit:</label>
	                                    	<div class="col-md-5 col-sm-6">
													{{ $leave_credit }}
		                                    </div>
		                                </div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
		                                    <label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('common.remarks') }} :</label>
	                                    	<div class="col-md-5 col-sm-6">
		                                        <textarea id="request_remarks" name="request_remarks" class="form-control" rows="3"></textarea>
		                                    </div>
		                                </div>
									</div>
								</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-offset-4 col-md-8">
                                            	<?php if(!count($ot_leave) > 0){ ?>
	                                            	<a href="#" class="btn btn-default btn-sm btn-success" onclick="update_request( $(this).closest('form'), 'approve')" >{{ lang('form_application_admin.approved') }}</a>
	                                            	<a href="#" class="btn btn-sm btn-danger" onclick="update_request( $(this).closest('form'), 'disapprove')" >{{ lang('form_application_admin.disapproved') }}</a>
