...
<div class="portlet">
	...
	<div class="portlet-body form">
		...
		<div class="form-group">
			<input type="hidden" class="form-control" name="training_application[training_calendar_id]" id="training_application-venue" value="{{ $record['training_application_training_calendar_id'] }}" readonly/>
		...
		<div class="form-group">
			...
			<div class="col-md-7">
				<textarea class="form-control" name="training_application[approver_remarks]" id="training_application-note" rows="4" @if($approver_details['training_application_status_id'] == 5) disabled @endif>@if (!empty($approver_details)) {{ $approver_details['remarks'] }} @endif</textarea>
			</div>	
		</div>		
	</div>
</div>
...
<script type="text/javascript" src="{{ theme_path() }}modules/training_request_manage/detail.js"></script>