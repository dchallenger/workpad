...
T5.training_application_status_id as "training_application_approver_status_id",
T5.training_application_status as "training_application_approver_status",
...
T3.calendar_type as "training_application_training_type", `ww_training_application`.`created_on` as "training_application_created_on", 
T4.training_application_status as "training_application_training_application_status",
T8.full_name as "training_application_user",
...
LEFT JOIN `ww_training_application_approver` T5 ON `T5`.`training_application_id` = `ww_training_application`.`training_application_id`
LEFT JOIN `ww_users` T8 ON `T8`.`user_id` = `ww_training_application`.`user_id`
WHERE (
