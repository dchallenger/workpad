<div class="portlet">
	...
	<div class="portlet-body form">
		...
		<div class="form-group">
			<label class="control-label col-md-3"><span class="required">* </span>{{ lang('mrf.dept_head') }}</label>
			<div class="col-md-5">
			...
			if($key_class->key_class_code != "hra_remarks"):?>
				<div class="portlet">
					...
					<div class="form-group hidden">
						...
						<div class="col-md-9">
							<div class="input-group">
								<input type="text" class="form-control input-medium" value="{{ $record['recruitment_request.age_range_from'] }}" name="recruitment_request[age_range_from]" {{ $record['disabled'] }}/> 
								&nbsp; - &nbsp;
					...
					<div class="form-group hidden">
						...
						<div class="col-md-5">
							<?php
								...
								$options = $db->get('partners_age_gender');
                	...
                	<div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div data-date-format="MM dd, yyyy" class="input-group input-medium date date-picker" data-date-start-date="+0d">
                                <input type="text" disabled class="form-control" size="16" id="recruitment_request-delivery_date" name="recruitment_request[delivery_date]" value="{{ ($record['recruitment_request.delivery_date'] != '1970-01-01' && $record['recruitment_request.delivery_date'] != '0000-00-00' ? $record['recruitment_request.delivery_date'] : '') }}">
                                <span class="input-group-btn">
