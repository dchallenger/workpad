<div class="portlet">
	...
	<div class="portlet-body form">
		...
		<div class="form-group">
			...
			<div class="col-md-5">
				...
				<?php
					...
					$recruitment_request_company_id_options = array('' => '');
		...
		<div class="form-group">
			...
			<div class="col-md-5">
				<?php
					...
					$recruitment_request_department_id_options = array('' => '');
					foreach($options->result() as $option)
					{
			...
			<div class="col-md-5">
				<div class="input-group">
					...
					<?php
						...
						// $value = isset( $key->key_value ) ? $key->key_value : '';
						echo form_dropdown('recruitment_request[nature_id]', $option, $record['recruitment_request.nature_id'], 'id="recruitment_request-nature_id" class="form-control select2me" data-placeholder="Select..." '.$record['disabled']);
					?>
				</div>	
			</div>
		</div>
		...
		<div class="form-group replacement_of">
			<label class="control-label col-md-3">
			{{ lang('mrf.replace_of') }}
			</label>
			<div class="col-md-5">
				<?php
					$db->select('users.user_id, full_name');
					$db->order_by('full_name', '0');
					$db->where('users.deleted', '0');
					$db->where('users.active', '1');
					$db->where('users.user_id != 1');
					$db->where('users_profile.department_id', $record['recruitment_request.department_id']);
					$db->join('users_profile','users.user_id=users_profile.user_id','left');
		...
		<div class="form-group location">
			...
			<div class="col-md-5">
				<input type="text" class="form-control" value="{{ $record['recruitment_request.replacement_transfer_location'] }}" name="recruitment_request[replacement_transfer_location]" /> 
			</div>	
		</div>
...
<?php
	$key_classes = $mod->get_key_classes();
	if( $key_classes )
	{
			...
			if($key_class->key_class_code != "hra_remarks"):?>
				<div class="portlet">
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<?php
								$db->where('users_position.deleted',0);
								//$db->join('users_department','approver_class_position.department_id = users_department.department_id');
								//$db->join('users_position','approver_class_position.position_id = users_position.position_id');
								$result = $db->get('users_position');

								$recruitment_request_position_id_options = array('' => '');
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							...
							<div class="input-group">
								...
								{{ form_dropdown('recruitment_request[rank_id]',$recruitment_request_job_grade_id_options, $record['recruitment_request.rank_id'], 'class="form-control select2me" data-placeholder="Select..." id="recruitment_request-rank_id" '.$record['disabled']) }}
							</div>
						</div>	
					</div>					
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="number_spinner">
							<div class="input-group input-small">
								...
								name="recruitment_request[contract_duration]" id="recruitment_request-contract_duration" value="{{ $record['recruitment_request.contract_duration'] }}" >
					    	...
					    	<!-- <input type="text" onkeypress="return isNumber(event)" name="recruitment_request[contract_duration]" id="recruitment_request-contract_duration" value="{{ $record['recruitment_request.contract_duration'] }}"  class="form-control"> -->
					    </div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">
						...
						<div class="number_spinner">
							<div class="input-group input-small">
								<input type="text" maxlength="3" {{ $record['disabled'] }} class="spinner-input form-control" onkeypress="return isNumber(event)" 
								name="recruitment_request[quantity]" id="recruitment_request-quantity" value="{{ $record['recruitment_request.quantity'] }}" >
								<div class="spinner-buttons input-group-btn btn-group-vertical">
					    	...
					    	<!-- <input type="text" onkeypress="return isNumber(event)" name="recruitment_request[quantity]" id="recruitment_request-quantity" value="{{ $record['recruitment_request.quantity'] }}"  class="form-control"> -->
					    </div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">
					...
					<div class="form-group hidden">
						...
						<div class="col-md-9">
							<div class="input-group">
								<input type="text" class="form-control input-medium" value="{{ $record['recruitment_request.age_range_from'] }}" name="recruitment_request[age_range_from]" /> 
								&nbsp; - &nbsp;
								<input type="text" class="form-control input-medium" value="{{ $record['recruitment_request.age_range_to'] }}" name="recruitment_request[age_range_to]" /> 
							</div>
						</div>	
					</div>	
					<div class="form-group hidden">
					...
					<div class="form-group hidden">
						...
						<div class="col-md-5">
							<input type="text" class="form-control" value="{{ $record['recruitment_request.max_no_personel'] }}" name="recruitment_request[max_no_personel]" /> 
						</div>	
					</div>	
					<div class="form-group hidden">
						<label class="control-label col-md-3"><span class="required">* </span>{{ lang('mrf.total_no_incumbet') }}</label>
						<div class="col-md-5">
							<input type="text" class="form-control" value="{{ $record['recruitment_request.total_no_incumbent'] }}" name="recruitment_request[total_no_incumbent]" /> 
						</div>	
					</div>											
					<div class="form-group hidden">
						...
						<div class="col-md-9">
							<div class="input-group">
								<input type="text" class="form-control input-medium mask_number" {{ $record['disabled'] }} value="{{ $record['recruitment_request.salary_from'] }}" id="recruitment_request-salary_from" name="recruitment_request[salary_from]" />
								&nbsp; - &nbsp;
								<input type="text" class="form-control input-medium mask_number" {{ $record['disabled'] }} value="{{ $record['recruitment_request.salary_to'] }}" id="recruitment_request-salary_from" name="recruitment_request[salary_to]" />
							</div>
						</div>	
					</div>
					<div class="form-group">
					...
					@foreach($approver as $key => $approvers)
							@if($approvers['status_id'] != 0)
								...
								<div class="form-group">
									...
									<div class="col-md-5 col-sm-7">
			                    		<textarea disabled rows="2" class="form-control" name="recruitment[comment]">{{ $approvers['comment'] }}</textarea>
									</div>
								</div>
								<hr />
							@endif	
            ...
            <div class="form-body">        	
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <textarea disabled class="form-control" rows="2" name="recruitment_request[hr_remarks]">{{ $record['recruitment_request.hr_remarks'] }}</textarea>
                        </div>
                    </div>
					...
					<?php
						...
						// $users_id_options = array('' => 'Select...');
					?>
                        	<input type="text" disabled class="form-control dontserializeme" size="16" id="recruitment_request-hr_remarks_by" name="recruitment_request[hr_remarks_by]" value="{{ $hr_remarks_by['full_name'] }}">
                        </div>
                    </div>
                	<div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div data-date-format="MM dd, yyyy" class="input-group input-medium date date-picker" data-date-start-date="+0d">
                                <input disabled type="text" class="form-control" size="16" id="recruitment_request-delivery_date" name="recruitment_request[delivery_date]" value="{{ ($record['recruitment_request.delivery_date'] != '1970-01-01' && $record['recruitment_request.delivery_date'] != '0000-00-00' ? $record['recruitment_request.delivery_date'] : '') }}">
                                <span class="input-group-btn">
...
<!--                     <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <textarea disabled class="form-control" rows="2" name="recruitment_request[closing_remarks]">{{ $record['recruitment_request.closing_remarks'] }}</textarea>
                        </div>
                    </div>
...
<script type="text/javascript" src="{{ theme_path() }}plugins/jquery-inputmask/jquery.inputmask.bundle.min.js"></script>  
@endif