						...
						<div class="portlet-body">
							<div class="tabbable-custom ">
								...
								@if ($permission_app_admin)
									<li class="active"><a href="{{ get_mod_route('form_application_admin') }}">{{ lang('common.admin') }}</a></li>
								@endif
								...
								@endif
								@if ($permission_app_blanket)
									<li class=""><a href="{{ get_mod_route('form_application_blanket') }}">{{ lang('common.blanket') }}</a></li>
								@endif
								</ul>
							                                	...
							                                	<div class="portlet margin-bottom-10">
																	...
																	<div class="portlet-body">
																		<div class="radio-list">
																			<label><input class="form-filter" type="radio" name="optionsRadios" id="optionsRadios2" value="option1" data-form-id="0" data-filter_value="0" checked> {{ lang('form_application_admin.all') }}</label>
																			@foreach ($leave_forms as $form_id => $form)
																			<label><input class="form-filter" type="radio" name="optionsRadios" id="optionsRadios2" value="option4" data-form-id="{{$form_id}}" filter_value="{{$form_id}}"> {{$form}}</label>
																			@endforeach
																		</div>
																	</div>
																</div>
																...
																<div class="portlet">
																	...
																	<div class="portlet-body">
																		<div class="radio-list">
																			...
																			<label><input class="status-filter" type="radio" name="optionsRadios" id="optionsRadios2" value="option4" data-form-status-id="{{$stat['form_status_id']}}" filter_value="{{$stat['form_status_id']}}"> {{$stat['form_status']}}</label>
																			@endforeach
																		</div>
																	</div>
																</div>																
