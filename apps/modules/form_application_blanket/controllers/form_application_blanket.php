...
class Form_application_blanket extends MY_PrivateController
{
	public function __construct()
	{
		$this->load->model('form_application_blanket_model', 'mod');
		parent::__construct();
	}
    ...
    public function detail( $record_id, $child_call = false )
    {
        ...
        $data['time_forms_user_id'] = $forms_info['user_id'];
        ...
        switch( $form_info['form_id'] ){
            ...
            case get_time_form_id('CWS'):
                $data['shifts'] = $this->mod->get_shifts();
                $data['shift_details'] = $this->mod->get_shift_details(date("Y-m-d", strtotime($data['form_approver_details']['date_from'])), $forms_info['user_id']);
                $data['shift_id']['val'] = $forms_data['time_forms_date.shift_id'];
            break;
    ...
    public function edit($record_id = "", $child_call = false)
    {
        ...
        $data['record']['users_division.division_id'] = '';
    ...
    function save_form()
    {
        ...
        switch($form_id){
            ...
            break;                   
            case get_time_form_id('UT')://UT
                $_POST['date_from'] = $_POST['focus_date']; 
                $_POST['date_to'] = $_POST['focus_date'];
