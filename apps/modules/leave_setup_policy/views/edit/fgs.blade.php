			...
			<div class="form-group">
				...
				<div class="col-md-7">
	            	...
	            	<div class="input-group">
	                    ...
	                    {{ form_multiselect('time_form_balance_setup_policy[company_id_ids][]',$company, $company_ids_val, 'class="form-control select2me" data-placeholder="Select..." id="time_form_balance_setup_policy-company_id"') }}
	                </div>
	            </div>	
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
	            	...
	            	<div class="input-group">
	                    ...
	                    {{ form_multiselect('time_form_balance_setup_policy[employment_status_ids][]',$employment_status, $record['time_form_balance_setup_policy.company_id'], 'multiple class="form-control select2me" data-placeholder="Select..." id="time_form_balance_setup_policy-company_id"') }}
	                </div>
	            </div>	
			</div>
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" name="time_form_balance_setup_policy[description]" id="time_form_balance_setup_policy-starting_credit" value="{{ $record['time_form_balance_setup_policy.starting_credit'] }}" placeholder="Enter Description" />
				</div>	
			</div>			
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
                    ...
                    <div class="input-group">
	                    ...
	                    {{ form_dropdown('time_form_balance_setup_policy[accumulation_type]',$accumulation_type, $record['time_form_balance_setup_policy.form_id'], 'class="form-control select2me" data-placeholder="Select..." id="time_form_balance_setup_policy-form_id"') }}
	                </div>
	            </div>	
			</div>			
			<div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="make-switch" data-on-label="&nbsp;Yes&nbsp;" data-off-label="&nbsp;No&nbsp;">
                        ...
                        <input type="checkbox" value="1" checked="checked" name="partners_personal[home_leave][temp]" id="partners_personal-home_leave-temp" class="dontserializeme toggle"/>
                        <!-- <input type="hidden" name="time_form_balance_setup_policy[prorated]" id="partners_personal-home_leave" value="@if( $personal_home_leave ) 1 else 0 @endif"/> -->
	                    <input type="hidden" name="time_form_balance_setup_policy[prorated]" id="partners_personal-home_leave" value=""/>
                    </div> 
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
                        <input type="text" class="form-control" name="time_form_balance_setup_policy[leave_reset_date]" id="partners-original_hired_date" value="" placeholder="Enter Leave Reset Date" >
