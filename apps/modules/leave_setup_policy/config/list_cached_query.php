...
$config["list_cached_query"] = 'SELECT `ww_time_form_balance_setup_policy`.`policy_id` as record_id, 
										...
										ww_time_form_balance_setup_policy.employment_type_ids as "time_form_balance_setup_policy_balance_setup_id", 
										ww_time_form_balance_setup_policy.employment_status_ids as "employment_status", 
										...
										WHERE ww_time_form_balance_setup_policy.deleted = 0 AND (
												...
												ww_time_form_balance_setup_policy.employment_type_ids like "%{$search}%"
											)';