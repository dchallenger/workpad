...
IF(ww_time_form_balance_setup_policy.accumulation_type = 1,"Monthly",IF(ww_time_form_balance_setup_policy.accumulation_type = 2,"Yearly","Tenure")) as "time_form_balance_setup_policy.accumulation_type",
