<div class="portlet">
	<div class="portlet-title">
		<div class="caption">Training Request for Confirmation</div>
	...
	<div class="portlet-body form">
		...
		<div class="form-group">
			...
			<div class="col-md-7">							
				...
				<input type="hidden" class="form-control" name="training_calendar[min_training_capacity]" id="training_calendar-min_training_capacity" value="{{ $record['training_calendar.min_training_capacity'] }}" placeholder="Enter Maximum Trainee Capacity" />
			</div>	
		</div>
