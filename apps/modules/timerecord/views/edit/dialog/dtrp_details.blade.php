...
<div id="time_forms_info" class="hidden">
    ...
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted small'>{{ lang('timerecord.time_in') }}</label>
        <div class='col-md-9'>
    ...
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted small'>{{ lang('timerecord.time_out') }}</label>
        <div class='col-md-9'>
