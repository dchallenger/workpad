...
$config["list_cached_query"] = 'SELECT `ww_payroll_period`.`payroll_period_id` as record_id, DATE_FORMAT(ww_payroll_period.posting_date, \'%M %d, %Y\') as "payroll_period_posting_date", T6.week as "payroll_period_week", T5.payroll_schedule as "payroll_period_payroll_schedule_id", T4.period_processing_type as "payroll_period_period_processing_type_id", T3.apply_to as "payroll_period_apply_to_id", T7.period_status as "payroll_period_period_status_id", CONCAT(DATE_FORMAT(ww_payroll_period.date_from, \'%M %d, %Y\'), \' to \', DATE_FORMAT(ww_payroll_period.date_to, \'%M %d, %Y\')) as "payroll_period_date", DATE_FORMAT(ww_payroll_period.payroll_date, \'%M %d, %Y\') as "payroll_period_payroll_date", ww_payroll_period.remarks as "payroll_period_remarks", `ww_payroll_period`.`created_on` as "payroll_period_created_on", `ww_payroll_period`.`created_by` as "payroll_period_created_by", `ww_payroll_period`.`modified_on` as "payroll_period_modified_on", `ww_payroll_period`.`modified_by` as "payroll_period_modified_by"
...
WHERE (
	DATE_FORMAT(ww_payroll_period.posting_date, \'%M %d, %Y\') like "%{$search}%" OR 
