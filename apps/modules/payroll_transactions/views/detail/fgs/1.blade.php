<div class="portlet">
	...
	<div class="portlet-body form">			<div class="form-group">
				...
				<div class="col-md-7">							<input type="text" class="form-control" name="payroll_transaction[transaction_code]" id="payroll_transaction-transaction_code" value="{{ $record['payroll_transaction.transaction_code'] }}" placeholder="Enter Transaction Code"/> 				</div>	
			</div>			<div class="form-group">
				<label class="control-label col-md-3"><span class="required">* </span>Transaction Label</label>
				<div class="col-md-7">							<input type="text" class="form-control" name="payroll_transaction[transaction_label]" id="payroll_transaction-transaction_label" value="{{ $record['payroll_transaction.transaction_label'] }}" placeholder="Enter Transaction Label"/> 				</div>	
			</div>			<div class="form-group">
