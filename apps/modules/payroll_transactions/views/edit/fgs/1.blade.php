<div class="portlet">
	...
	<div class="portlet-body form">			
		...
		<div class="form-group">
			...
			<div class="col-md-7">							
				<input type="text" class="form-control" name="payroll_transaction[transaction_label]" id="payroll_transaction-transaction_label" value="{{ $record['payroll_transaction.transaction_label'] }}" placeholder="{{ lang('payroll_transactions.p_trans_label') }}"/> 				</div>	
			</div>			
		<div class="form-group">
			<label class="control-label col-md-3">{{ lang('payroll_transactions.trans_class') }}</label>
		...
		<div class="form-group">
			<label class="control-label col-md-3">{{ lang('payroll_transactions.priority') }}</label>
			<div class="col-md-7"><?php	                            	                            		
