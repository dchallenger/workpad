...
class Performance_appraisal_contributor extends MY_PrivateController
{
    ...
    function edit( $record_id = "", $child_call = false, $manager_id = '' )
    {
        $appraisal_id = $record_id; // change into this to fix with upgrade version. should the same with the parent class
        $user_id = $child_call; // change into this to fix with upgrade version. should the same with the parent class
