        ...
        <div class="col-md-9">
				...
				<div id="vl_container" class="portlet">
						<div class="portlet-title">
							<div class="caption">Business Trip Form <small class="text-muted">{{ lang('form_application_manage.view') }}</small></div>
						</div>
	                        ...
	                        <!-- BEGIN FORM-->
	                            <div class="form-body">
	                            	...
	                            	<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('form_application_manage.location') }} :<span class='required'>*</span></label>
												<div class="col-md-7 col-sm-7">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('form_application_manage.comp_name') }} :</label>
												<div class="col-md-7 col-sm-7">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('form_application_manage.contact_person') }} :</label>
												<div class="col-md-7 col-sm-7">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('form_application_manage.pos_title') }} :</label>
												<div class="col-md-7 col-sm-7">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('form_application_manage.contact_num') }} :</label>
												<div class="col-md-7 col-sm-7">
											...
											<div class="col-md-12">
												<div class="form-group">
				                                    ...
				                                    <div class="col-md-5 col-sm-6">
				                                        ...
				                                        <label class="control-label col-md-10 text-muted small"> {{ lang('form_application_manage.required_disapp') }}</label>
				                                    </div>
				                                </div>
											</div>
										</div>
