        ...
        <div class="col-md-9">
				...
				<div id="vl_container" class="portlet">
						<div class="portlet-title">
							<div class="caption">Maternity Leave <small class="text-muted">{{ lang('form_application_manage.view') }}</small></div>
						</div>
	                        ...
	                        <!-- BEGIN FORM-->
	                            <div class="form-body">
	                            	...
	                            	<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('form_application_manage.delivery') }} :</label>
												<div class="col-md-7 col-sm-7">
													<span>
														<?php
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('form_application_manage.num_preg') }} :</label>
												<div class="col-md-7 col-sm-7">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('form_application_manage.expected_delivery') }} :</label>
												<div class="col-md-7 col-sm-7">
