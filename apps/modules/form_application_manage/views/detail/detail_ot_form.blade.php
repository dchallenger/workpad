        ...
        <div class="col-md-9">
				...
				<div id="vl_container" class="portlet">
						<div class="portlet-title">
							<div class="caption">Overtime Form <small class="text-muted">{{ lang('form_application_manage.view') }}</small></div>
						</div>
											...
											<div class="col-md-12">
												<div class="form-group">
				                                    ...
				                                    <div class="col-md-5 col-sm-6">
				                                        ...
				                                        <label class="control-label col-md-9 text-muted small"> {{ lang('form_application_manage.required_disapp') }}</label>
				                                    </div>
				                                </div>
											</div>
										</div>
