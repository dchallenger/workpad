						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-md-7 col-sm-7">
										<button id="goto_vl_co" class="btn blue" type="button"><small>{{ lang('form_application_manage.view_options') }}</small></button>
									
										<div class="help-block small">
											{{ lang('form_application_manage.click_viewopt') }}
										</div>
									</div>
								</div>
							</div>
