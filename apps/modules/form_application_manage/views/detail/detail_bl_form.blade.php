        ...
        <div class="col-md-9">
				...
				<div id="vl_container" class="portlet">
						<div class="portlet-title">
							<div class="caption">{{ lang('form_application_manage.bl') }} <small class="text-muted">{{ lang('form_application_manage.view') }}</small></div>
						</div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-md-7 col-sm-7">
													<span><?php echo date('F d, Y - D',strtotime($date_adc)) ?></span>
												</div>
											</div>
										</div>
									</div>
