<div class="portlet">
	...
	<div class="portlet-body form">
		<div class="form-group">
			...
			<div class="col-md-7">
				<input type="text" disabled="disabled" class="form-control" name="users[login]" id="users-login" value="{{ $record['users.login'] }}" placeholder="{{ lang('users.p_user_login') }}" /> 	
			</div>	
		</div>
		<!-- <div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-7"><?php	$db->select('company_id,company');
	                            		...
	                            		$users_profile_company_id_options = array('' => 'Select...');
                ...
                <div class="input-group">
	                ...
	                {{ form_dropdown('users_profile[company_id]',$users_profile_company_id_options, $record['users_profile.company_id'], 'disabled="disabled" class="form-control select2me" data-placeholder="Select..."') }}
	            </div>
	        </div>	
		</div>
		<div class="form-group">
			<label class="control-label col-md-3"><span class="required">* </span>{{ lang('users.role') }}</label>
			<div class="col-md-7"><?php	$db->select('role_id,role');
                ...
                <div class="input-group">
					<span class="input-group-addon"><i class="fa fa-list-ul"></i></span>
	                    {{ form_dropdown('users[role_id]',$users_role_id_options, $record['users.role_id'], 'disabled="disabled" class="form-control select2me" data-placeholder="Select..."') }}
	            </div>
	        </div>	
		</div>
			@if( $current_user->role_id == 1 )
				<div class="form-group">
					...
					<div class="col-md-7"><?php	$db->select('level_id,level');
		                            			...
		                            			$users_level_id_options = array('' => 'Select...');
	                        		foreach($options->result() as $option)
	                        		{
	                    ...
	                    <div class="input-group">
							<span class="input-group-addon"><i class="fa fa-list-ul"></i></span>
		                    {{ form_dropdown('users_profile[business_level_id]',$users_level_id_options, $record['users_profile.level_id'], 'disabled="disabled" class="form-control select2me" data-placeholder="Select..."') }}
		                </div>
		            </div>	
				</div>
			@endif
	...
	<div class="portlet">
		...
		<div class="portlet-body form">
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" disabled="disabled" class="form-control" name="users_profile[firstname]" id="users_profile-firstname" value="{{ $record['users_profile.firstname'] }}" placeholder="{{ lang('users.p_firstname') }}" />
				</div>	
			</div>
			<div class="form-group">
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('users.lastname') }}</label>
				<div class="col-md-7">
					<input type="text" disabled="disabled" class="form-control" name="users_profile[lastname]" id="users_profile-lastname" value="{{ $record['users_profile.lastname'] }}" placeholder="{{ lang('users.p_lastname') }}" />
				</div>	
			</div>
			<div class="form-group">
				<label class="control-label col-md-3">{{ lang('users.middlename') }}</label>
				<div class="col-md-7">
					<input type="text" disabled="disabled" class="form-control" name="users_profile[middlename]" id="users_profile-middlename" value="{{ $record['users_profile.middlename'] }}" placeholder="{{ lang('users.p_middlename') }}" /> 				
				</div>	
			</div>
			<div class="form-group">
				<label class="control-label col-md-3">{{ lang('users.suffix') }}</label>
				<div class="col-md-7">
					<input type="text" disabled="disabled" class="form-control" name="users_profile[suffix]" id="users_profile-suffix" value="{{ $record['users_profile.suffix'] }}" placeholder="{{ lang('users.p_suffix') }}" /> 				
				</div>	
			</div>
			<div class="form-group">
				<label class="control-label col-md-3">{{ lang('users.nickname') }}</label>
				<div class="col-md-7">
					<input type="text" disabled="disabled" class="form-control" name="users_profile[nickname]" id="users_profile-nickname" value="{{ $record['users_profile.nickname'] }}" placeholder="{{ lang('users.p_nickname') }}" /> 				
				</div>	
			</div>			
			<div class="form-group">
				...
				<div class="col-md-7">
					<div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
						<input type="text" disabled="disabled" class="form-control" name="users_profile[birth_date]" id="users_profile-birth_date" value="{{ $record['users_profile.birth_date'] }}" placeholder="{{ lang('users.p_birth_date') }}" readonly>
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<div class="input-group">
						...
						<input type="text" disabled="disabled" class="form-control" name="users[email]" id="users-email" value="{{ $record['users.email'] }}" placeholder="{{ lang('users.p_email') }}" /> 	
					</div>	
				</div>	
			</div>
		</div>
