...
IF(ww_time_forms.user_id = 0,ww_time_forms.display_name,"") AS blanket,
...
LEFT JOIN `ww_time_forms_blanket` ON `ww_time_forms_blanket`.`forms_id` = `ww_time_forms`.`forms_id`
