	                        ...
	                        <!-- BEGIN FORM-->
								...
								<div name="et_ut_type" id="et_ut_type" class="@if($res_type==2) hidden @endif">
	                                <div class="row @if($res_type==1) hidden @endif">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('form_application.date') }} :</label>
												<div class="col-md-7 col-sm-7">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-md-4 col-sm-4 text-right text-muted">{{ lang('form_application.time') }} :</label>
												<div class="col-md-7 col-sm-7">
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="col-md-7 col-sm-7">
													...
													?>
													<span class="help-block small">{{ $value['form_status'] }} {{ $comment_date }}<!-- {{ ($value['date'] == '0000-00-00 00:00:00') ? '' : 'on '.date('F d, Y g:ia', strtotime($value['date'])) }} --></span>
												</div>
											</div>
										</div>
									</div>
