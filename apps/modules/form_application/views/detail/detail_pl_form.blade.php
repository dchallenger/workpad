				...
				<div id="vl_container" class="portlet">
	                    ...
	                    <div class="portlet-body form" id="main_form">
	                        <!-- BEGIN FORM-->
	                            ...
	                            @if (in_array($form_status_id['val'],[2,4,8]))
		                            <hr />
	                        		<div class="row">
										<div class="col-md-12">
											<div class="form-group">
			                                    ...
			                                    <div class="col-md-5 col-sm-6">
			                                        <textarea id="remarks" class="form-control" rows="3" @if(!in_array($form_status_id['val'],[2,4])) readonly="readonly" @endif>{{ $cancelled_remarks_by_user }}</textarea>
