                        ...
                        <div class="form-group">
							...
							<div class="col-md-6">
								<?php	                            	                            		
				                            ...
				                            {{ form_dropdown('time_forms_maternity[delivery_id]',$time_delivery_delivery_id_options, $record['time_forms_maternity.delivery_id'], 'id="time_forms_maternity-delivery_id" class="form-control select2me" data-placeholder="Select..."') }}
				                        </div> 				</div>	
						</div>
						<div class="form-group">
								<label class="control-label col-md-4">{{ lang('form_application.from') }}<span class="required">* </span></label>
								<div class="col-md-6">							<div class="maternity_date_from input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
							...
							<div class="form-group">
                             ...
                             <div class="form-group">
								<label class="control-label col-md-4">{{ lang('form_application.expected_delivery') }}</label>
								<div class="col-md-6">							<div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
												<input type="text" class="form-control" name="time_forms_maternity[expected_date]" id="time_forms_maternity-expected_date" value="{{ $record['time_forms_maternity.expected_date'] }}" placeholder="Enter Expected Delivery">
												<span class="input-group-btn">
													<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
											</div> 				
							...
							<div class="form-group">
								...
								<div class="col-md-6">							<div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
												<input type="text" class="form-control" name="time_forms_maternity[actual_date]" id="time_forms_maternity-actual_date" value="{{ $record['time_forms_maternity.actual_date'] }}" placeholder="Enter Actual Delivery">
												<span class="input-group-btn">
													<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
											</div> 				
