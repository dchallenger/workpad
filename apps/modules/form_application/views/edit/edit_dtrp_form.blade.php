					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<div class="input-group">
								...
								{{ form_dropdown('dtrp_type',$dtrp_type_options, $dtrp_type, 'id="dtrp_type" class="form-control select2me" data-placeholder="Select..."') }}
							</div> 				
						</div>	
					</div>

					<div class="form-group">
						<label class="control-label col-md-4">{{ lang('form_application.dtrp_date') }}<span class="required">* </span></label>
						<div class="col-md-6">							
					...
					<div class="form-group">
						...
						<div class="col-md-6">							<div data-provides="fileupload" class="fileupload fileupload-new" id="time_forms_upload-upload_id-container">
							...
							<span class="btn default btn-sm btn-file">
								...
								<input type="file" id="time_forms_upload-upload_id-fileupload" name="files[]" multiple="">
							</span>
