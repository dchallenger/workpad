			...
			<form class="form-horizontal" action="<?php echo $url?>/save_form">
				...
				<div class="portlet">
					...
					<div name="use_type" id="use_type">
						...
						<div class="form-group">
							<label class="control-label col-md-4">{{ lang('form_application.additional') }} Credits<span class="required">* </span></label>
							<div class="col-md-5">							
							<?php
								...
								{
									if($option['remarks'] != 'Complimentary Leave - Perfect Attendance'){

										$add_leave_credits_options[$option['forms_id']] = date('F d, Y', strtotime($option['date_from'])).' - '.($option['balance']==1 ? "Whole day" : "Half day");
									}
									else{
										$add_leave_credits_options[$option['forms_id']] = date('F Y', strtotime($option['date_from'])) . ' Perfect Attendance';
									}
								} 
							?>
								<div class="input-group">
