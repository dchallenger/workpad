			...
			<div class="portlet">
				...
				<div class="portlet-body form" id="main_form">			
					...
					<div class="form-group">
						...
						<div class="col-md-6">							
							<input type="text" class="form-control" name="time_forms_obt[company_to_visit]" id="time_forms_obt-company_to_visit" value="{{ $record['time_forms_obt_company_to_visit'] }}" placeholder=""/> 				
						</div>	
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">							
							<input type="text" class="form-control" name="time_forms_obt[name]" id="time_forms_obt-name" value="{{ $record['time_forms_obt_name'] }}" placeholder=""/> 				
						</div>	
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">							
							<input type="text" class="form-control" name="time_forms_obt[position]" id="time_forms_obt-position" value="{{ $record['time_forms_obt_position'] }}" placeholder=""/> 				
						</div>	
					</div>
