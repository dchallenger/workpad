	...
	<div class="portlet-body form" id="main_form">						
					...
					<div class="form-group hidden">
						...
						<div class="col-md-6">
							...
							$schedule_options['YES'] = 'Scheduled';
							$schedule_options['NO'] = 'Unscheduled';
							...
							<div class="input-group">
								...
								{{ form_dropdown('scheduled',$schedule_options, $scheduled, 'id="scheduled" class="form-control select2me" data-placeholder="Select..."') }}
							</div> 				
						</div>	
					</div>
		...
		<div class="form-group">
			...
			<div class="form-group">
								<label class="control-label col-md-4">{{ lang('form_application.file_upload') }}
								@if( isset($policy_attachment) && $policy_attachment > 0 )
				  ...
				  <div class="row">
				    <div class="col-md-12">
				      <div class="col-md-offset-4 col-md-8">
						...
						?>
				        <a href="{{ $back_url }}" class="btn default btn-sm">{{ lang('form_application.back') }}</a>
				      </div>
				    </div>
				  </div>
				</div>
