							                                	...
							                                	<div class="portlet margin-bottom-10">
																	...
																	<div class="portlet-body">
																		<div class="radio-list">
																			<label><input class="form-filter" type="radio" name="optionsRadios" id="optionsRadios2" value="option1" data-form-id="0" data-filter_value="0" checked> {{ lang('form_application.all') }}</label>
                ...
                <div class="col-md-3 visible-lg visible-md">
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							...
							<div class="margin-top-15">
								<span class="status-filter label label-info label-filter pading-3" filter_value="0">{{ lang('form_application.all') }}</span>
