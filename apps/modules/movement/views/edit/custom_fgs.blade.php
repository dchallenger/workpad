...
?>	
	...
	<div class="portlet-body form">
		...
		<div class="form-group reason_leaving" style="display:none">
			<label class="control-label col-md-3">Reason for Leaving</label>
			<div class="col-md-7">							
				<textarea class="form-control" name="partners_movement_action[reason_leaving]" id="partners_movement-reason_leaving" placeholder="Enter Reason for Leaving" rows="4"><?php echo $record['partners_movement_action.reason_leaving'] ?></textarea> 				
			</div>	
		</div>			
		<div class="form-group">
