		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="form-group">
					...
					<div class="col-md-7">
						<?php echo $record['partners_movement_due_to_id'] ?>
					</div>	
				</div>	
				<div class="form-group">
					<label class="col-md-4 text-muted text-right">
				...
				?>
				@if ($record['partners_movement_action.user_id'] != $record['partners_movement_action.created_by'])
				<div class="form-group">
					<label class="col-md-4 text-muted text-right">
						Requested By:
					</label>
					...
					if(count($movement_details) > 0){
						foreach($movement_details as $index => $movement_detail){
							...
							<tr class="record">
								...
								<td class="hidden-xs">
									<?php echo ($movement_detail['effectivity_date'] && $movement_detail['effectivity_date'] != '0000-00-00' && $record['partners_movement_action_effectivity_date'] != 'January 01, 1970') ? date('F d, Y', strtotime($movement_detail['effectivity_date'])) : '' ?>	
								</td>
								<td class="hidden-xs">
