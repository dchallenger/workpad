<tr rel="3">
    ...
    <td>
        <span id="time_name">{{$full_name}}</span>
        <br>
    ...
    <td class="">
        ...
        <br>
        <span class="small text-muted">{{$timeout_date}}</span></span>
    </td>
    ...
    <td class="hidden-xs text-right" style="border-left:1px solid #eeeeee"> 
        ...
        <span class="badge badge-<?php echo $form_style; ?> custom_popover" 
                onclick="get_form_details(<?php echo $form['form_id'] ?>, <?php echo $form['forms_id'] ?>, '<?php echo $form['date'] ?>', <?php echo $form['user_id'] ?>)"
