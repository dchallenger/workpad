...
<div id="time_forms_info" class="hidden">
    ...
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted text-left small'>{{ lang('timerecord.current_sched') }}:</label>
        <div class='col-md-9'>
            <span> <?php echo $curr_shift; ?></span>
        </div>
    </div>
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted text-left small'>{{ lang('timerecord.new_sched') }}:</label>
        <div class='col-md-9'>
            <span> <?php echo $to_shift; ?></span>
        </div>
    </div>
    <div class='clearfix'>
        <label class='control-label col-md-3 text-muted text-left small'>{{ lang('timerecord.date') }}:</label>
        <div class='col-md-9'>
