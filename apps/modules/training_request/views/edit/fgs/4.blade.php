<div class="portlet">
	<div class="portlet-title">
		...
		<div class="portlet-body form">
				...
				<div class="col-md-7">
					<?php									                            		$db->select('type_id,training_type');
				...
				<div class="col-md-7">
					<?php									                            		$db->select('course_id,course');
				...
				<div class="col-md-7">
					<?php									                            		$db->select('provider_id,provider');
				...
				<div class="col-md-7">
												<input type="text" class="form-control" name="training_application[venue]" id="training_application-venue" value="{{ $record['training_application.venue'] }}" placeholder="Enter Venue" /> 				</div>	
			</div>			<div class="form-group">
				<label class="control-label col-md-3">Total Training Hours</label>
				<div class="col-md-7">
												<input type="text" class="form-control" name="training_application[total_training_hour]" id="training_application-total_training_hour" value="{{ $record['training_application.total_training_hour'] }}" placeholder="Enter Total Training Hours" /> 				</div>	
			</div>			<div class="form-group">
				<label class="control-label col-md-3">Estimate Investment (Subject for revision by HR):</label>
				<div class="col-md-7">
												<input type="text" class="form-control" name="training_application[total_investment_pgsa]" id="training_application-total_investment_pgsa" value="{{ $record['training_application.total_investment_pgsa'] }}" placeholder="Enter Estimate Investment (Subject for revision by HR):" /> 				</div>	
			</div>			<div class="form-group">
				<label class="control-label col-md-3">Areas for Development</label>
				<div class="col-md-7">
					<?php									                            		$db->select('appraisal_areas_development_id,appraisal_areas_development');
	                            			                            		$db->order_by('appraisal_areas_development', '0');
	                            		$db->where('deleted', '0');
	                            		$options = $db->get('performance_appraisal_areas_development'); 	                            $training_application_areas_development_options = array('' => 'Select...');
                        		foreach($options->result() as $option)
                        		{
	                            ...
	                            {{ form_dropdown('training_application[areas_development]',$training_application_areas_development_options, $record['training_application.areas_development'], 'class="form-control select2me" data-placeholder="Select..." id="training_application-areas_development"') }}
	                        </div> 				</div>	
			</div>			<div class="form-group">
				...
				<div class="col-md-7">
												<textarea class="form-control" name="training_application[note]" id="training_application-note" placeholder="Enter NOTE: (If Training will exceed in 1 Month):" rows="4">{{ $record['training_application.note'] }}</textarea> 				</div>	
			</div>			<div class="form-group">
