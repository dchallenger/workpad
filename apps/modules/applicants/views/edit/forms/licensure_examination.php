<div class="portlet">
    ...
    <div class="portlet-body form">
        ...
        <!-- START FORM -->                 
                ...
                <div class="form-group">
                    <label class="control-label col-md-3"><?php echo lang('applicants.license_no') ?></label>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <span class="pull-left"><input type="text" class="form-control input-small" maxlength="4" name="recruitment_personal_history[licensure-year-taken][]" id="recruitment_personal_history-licensure-year-taken" placeholder="Year"></span>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3"><?php echo lang('applicants.validity_until') ?></label>
                    <div class="col-md-9">
                        <div class="input-group input-medium pull-left">
                            <select  class="form-control form-select" data-placeholder="Select Month.." name="recruitment_personal_history[licensure-month-validity-until][]" id="recruitment_personal_history-licensure-month-validity-until">
                                <option value="January">January</option>
                                <option value="February">February</option>
                                <option value="March">March</option>
                                <option value="April">April</option>
                        ...
                        <span class="pull-left padding-left-right-10">-</span>
                        <span class="pull-left"><input type="text" class="form-control input-small" maxlength="4" name="recruitment_personal_history[licensure-year-validity-unti][]" id="recruitment_personal_history-licensure-year-validity-until" placeholder="Year" data-inputmask="'mask': '9999'"></span>
                    </div>
                </div>                 
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="recruitment_personal_history[licensure-attach][]" id="recruitment_personal_history-licensure-attach" value=""/>
