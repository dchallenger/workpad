            ...
            <div class="form-horizontal">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="recruitment_personal_history[test-title][]" id="recruitment_personal_history-test-title" placeholder="Enter Title"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group input-medium date date-picker" data-date-format="MM dd, yyyy">
                                <input type="text" class="form-control" name="recruitment_personal_history[test-date-taken][]" id="recruitment_personal_history-test-date-taken" value="" placeholder="Enter Date Taken" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="recruitment_personal_history[test-location][]" id="recruitment_personal_history-test-location" placeholder="Enter Location"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Score/Rating</label>
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="recruitment_personal_history[test-score][]" id="recruitment_personal_history-test-score" placeholder="Enter Score/Rating" data-inputmask="'mask': '9', 'repeat': 3, 'greedy' : false"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="make-switch" data-on="success" data-off="danger" data-on-label="&nbsp;Passed&nbsp;" data-off-label="&nbsp;Failed&nbsp;">
                                <input type="checkbox" value="1" checked="checked" name="recruitment_personal_history[test-result][temp][]" id="recruitment_personal_history-test-result-temp" class="dontserializeme toggle exam_result"/>
                                <input type="hidden" name="recruitment_personal_history[test-result][]" id="recruitment_personal_history-test-result" value="1"/>
                            </div> 
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea rows="3" class="form-control"name="recruitment_personal_history[test-remarks][]" id="recruitment_personal_history-test-remarks" ></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Supporting Documents</label>
                        <div class="col-md-9">
                            <div class="fileupload fileupload-new" data-provides="fileupload" id="recruitment_personal_history-test-attachments-container">
                                <!-- <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"> -->
                                    <?php 
                                        $filename = ''; 
                                    ?>

                                    <input type="hidden" name="recruitment_personal_history[test-attachments][]" id="recruitment_personal_history-test-attachments" value="">
                                <!-- </div> -->
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="btn default btn-file add_file">
                                        ...
                                        <input type="file" name="files[]" class="default file test_attach" id="recruitment_personal_history-test-attachments-fileupload" />
                                    </span>
