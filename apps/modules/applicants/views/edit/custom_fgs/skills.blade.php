<div class="portlet">
	<div class="portlet-title">
		<div class="caption" id="education-category">{{ lang('applicants.skills') }}</div>
		<div class="actions">
...
<!--                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="recruitment_personal_history[skill-name][]" id="recruitment_personal_history-skill-name" 
                        value="<?php echo (isset($skill['skill-name']) ? $skill['skill-name'] : ""); ?>" placeholder="Enter Name"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">{{ lang('applicants.proficiency_level') }}<span class="required">*</span></label>
                    <div class="col-md-6">
                        <?php
                        ...
                        {{ form_dropdown('recruitment_personal_history[skill-level][]',$users_proficiency_level_options, $skill['skill-level'], 'class="form-control select2me" data-placeholder="Select..."') }}
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <textarea rows="3" class="form-control" name="recruitment_personal_history[skill-remarks][]" id="recruitment_personal_history-skill-remarks" ><?php echo (isset($skill['skill-remarks']) ? $skill['skill-remarks'] : ""); ?></textarea>
                    </div>
                </div>
