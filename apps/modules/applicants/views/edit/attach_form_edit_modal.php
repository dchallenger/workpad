                        ...
                        <div class="form-horizontal">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">                          
                                        <div data-provides="fileupload" class="fileupload fileupload-new" id="recruitment_personal_history-file-container">
                                            <input type="hidden" name="recruitment_personal_history[attachment-file]" id="recruitment_personal_history-file" value="<?php echo (isset($details['attachment-file']) ? $details['attachment-file'] : ""); ?>"/>
                                            <div class="input-group">
                                                ...
                                                <span class="btn default btn-file">
                                                    ...
                                                    <input type="file" id="recruitment_personal_history-file-fileupload" type="file" name="files[]">
                                                </span>
