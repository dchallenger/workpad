                ...
                <div class="form-horizontal">
                    <div class="form-body">
                                    ...
                                    <option value="">{{ lang('applicants.select') }}</option>
                                        ...
                                        @if( sizeof( $employee ) > 0 )
                                            @foreach( $employee as $key => $val )
                                                <?php
                                                if(isset($friend_relative['friend-relative-employee']) && $friend_relative['friend-relative-employee'] == $val['user_id']) {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-icon">
                                    <input value="<?php echo (isset($friend_relative['friend-relative-position']) ? $friend_relative['friend-relative-position'] : ""); ?>" type="text" class="form-control" maxlength="64" name="recruitment_personal_history[friend-relative-position][]" id="friend-relative-position">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-icon">
                                    <input value="<?php echo (isset($friend_relative['friend-relative-dept']) ? $friend_relative['friend-relative-dept'] : ""); ?>" type="text" class="form-control" maxlength="64" name="recruitment_personal_history[friend-relative-dept][]" id="recruitment-friend-relative-dept">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-icon">
                                    <input value="<?php echo (isset($friend_relative['friend-relative-relation']) ? $friend_relative['friend-relative-relation'] : ""); ?>" type="text" class="form-control" maxlength="64" name="recruitment_personal_history[friend-relative-relation][]" id="friend-relative-relation">
                                </div>
