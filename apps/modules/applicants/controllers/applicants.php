...
class Applicants extends MY_PrivateController
{
	...
	public function edit( $recruit_id=0, $child_call = false )
	{
		$record_check = false;
...
/*			$validation_rules[] = 
		...
		if (isset($post[$this->mod->table])) {
			...
			if (isset($main_record['lastname']))
				$this->response->lastname = $main_record['lastname'];
			
			if (isset($post['recruitment']['request_id'])) {
    ...
    function check_path( $path, $create = true )
    {
