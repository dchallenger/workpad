<div class="portlet">
	...
	<div class="portlet-body form">
		<div class="form-group">
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('division.company') }}</label>
				<div class="col-md-7"><?php	                            	                            		
	                 ...
	                 <div class="input-group">
	                            ...
	                            {{ form_dropdown('users_division[company_id]',$users_company_options, $record['users_division.company_id'], 'class="form-control select2me" id="division-company_id" data-placeholder="Select..."') }}
	                 </div> 				
				</div>	
		</div>			
		<div class="form-group">
		...
		<div class="form-group">
				<label class="control-label col-md-3"><span class="required">* </span>{{ lang('division.immediate_head') }}</label>
				<div class="col-md-7"><?php	                            	                            		
