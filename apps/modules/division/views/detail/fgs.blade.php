<div class="portlet">
	...
	<div class="portlet-body form">
		...
		<div class="form-group">
				...
				<div class="col-md-7">							
					<input type="text" disabled="disabled" class="form-control" name="users_division[division]" id="users_division-division" value="{{ $record['users_division.division'] }}" placeholder="{{ lang('division.p_division') }}"/> 				
				</div>	
		</div>			
		<div class="form-group">
			<label class="control-label col-md-3"><span class="required">* </span>{{ lang('division.division_code') }}</label>
				<div class="col-md-7">							
					<input type="text" disabled="disabled" class="form-control" name="users_division[division_code]" id="users_division-division_code" value="{{ $record['users_division.division_code'] }}" placeholder="{{ lang('division.p_division_code') }}"/> 				
				</div>	
		</div>			
		<div class="form-group">
			<label class="control-label col-md-3">{{ lang('division.immediate_head') }}</label>
				<div class="col-md-7">
            		...
            		<div class="input-group">
	                    ...
	                    {{ form_dropdown('users_division[immediate_id]',$users_division_immediate_id_options, $record['users_division.immediate_id'], 'disabled="disabled" class="form-control select2me" data-placeholder="Select..."') }}
	                </div> 				
	            </div>	
		</div>			
		<div class="form-group">
			<label class="control-label col-md-3">{{ lang('division.immediate_position') }}</label>
				<div class="col-md-7">							
					<input type="text" disabled="disabled" class="form-control" name="users_division[position]" id="users_division-position" value="{{ $record['users_division.position'] }}" placeholder="{{ lang('division.p_immediate_position') }}"/> 				
				</div>	
		</div>			
		<div class="form-group">
		...
		<div class="form-group">
				...
				<div class="col-md-7">
					<div class="make-switch" data-on-label="&nbsp;{{ lang('division.option_yes') }}&nbsp;" data-off-label="&nbsp;{{ lang('division.option_no') }}&nbsp;">
						<input type="checkbox" disabled="disabled" value="1" @if( $record['users_division.status_id'] ) checked="checked" @endif name="users_division[status_id][temp]" id="users_division-status_id-temp" class="dontserializeme toggle"/>
