<div class="portlet">
    ...
    <div class="portlet-body form">
        <div class="form-group">
            <label class="control-label col-md-3"><span class="required">* </span>Holiday</label>
            <div class="col-md-7">
        ...
        <div class="form-group">
            <label class="control-label col-md-3"><span class="required">* </span>Legal</label>
            <div class="col-md-7">
...
<div class="portlet">
    ...
    <div class="portlet-body form">
        <div class="form-group">
            <label class="control-label col-md-3"><span class="required">* </span>Location</label>
            <div class="col-md-7">
                <?php 
