				...
				<div class="portlet-body">
					<div >
						<ul class="nav nav-tabs ">
							...
							<li class="active"><a href="{{ get_mod_route('training_calendar') }}">{{ lang('common.personal') }}</a></li>
							@endif
							@if ($training_calendar_manage)
							<li class=""><a href="{{ get_mod_route('training_calendar_manage') }}">{{ lang('common.manage') }}</a></li>
							@endif
							@if ($training_calendar_admin)
							<li class=""><a href="{{ get_mod_route('training_calendar_admin') }}">{{ lang('common.admin') }}</a></li>
							@endif
						</ul>
					</div>
				</div>
