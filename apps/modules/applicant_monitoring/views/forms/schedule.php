            ...
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    ...
                    <form action="#" class="form-horizontal" name="schedule-form">
                        ...
                        <div class="form-body">
                            <div class="portlet">
                                <span class="pull-right margin-bottom-15"><div class="btn btn-success btn-xs" onclick="add_sched_row()">+ <?=lang('applicant_monitoring.add_interviewer')?></div></span>
                                <div class="portlet-body" >
                                    <table class="table table-condensed table-striped table-hover" >
                                                    ...
                                                    <tr class="step1_interview">
                                                        <td>
                                                            <div class="input-group date form_datetime">                                       
                                                                <input type="text" size="16" class="form-control sched_datetime" name="sched_date[]" value="<?php echo date('F d, Y - H:i', strtotime($sched->date))?>" />
                                     ...
                                     <div id="no_record" class="well" style="display:none">
                                        ...
                                        <span><p class="small margin-bottom-0"><?=lang('applicant_monitoring.no_record_schedule')?></p></span>
                                    </div>
                                </div>
                            </div>
                        </div>
