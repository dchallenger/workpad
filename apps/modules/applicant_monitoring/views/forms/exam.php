...
<div class="tab-pane active" id="tab_2-2">
    <div class="portlet">
        ...
        <div class="portlet-body form">
            <?php
                if($process->status_id > 3 || ($process->status_id == 2 && $process->from_seting_final_interview == 2)){
                    $disabled = "disabled";  
            ...
            <form action="#" class="form-horizontal" name="exam-form">
                <div class="form-body">
                    ...
                    <div class="portlet">
                        ...
                        <span class="pull-right margin-bottom-15" <?=$hidden?> >
                            ...
                            <table class="table table-condensed table-striped table-hover" >
                                ...
                                <tbody id="saved-exams"><?php
                                    ...
                                    <tr class="exam_assessment">
                                        ...
                                        <td>
                                            <input type="text" class="form-control" <?=$disabled?> maxlength="64" name="exam_name[]" value="<?php echo $exam['exam_name'] ?>">
                                        </td>
                                        <td>
                                            <div class="input-group date date-picker" data-date-format="MM dd, yyyy">
                                                <input type="text" size="16" <?=$disabled?> class="form-control" name="date_taken[]" value="<?php echo date( 'F d, Y', strtotime($exam['date_taken']) ) ?>">
                                        ...
                                        <td>
                                            <div class="make-switch" data-off="danger" data-on="success" data-on-label="&nbsp;Passed&nbsp;&nbsp;" data-off-label="&nbsp;Failed&nbsp;">
                                             <input type="checkbox" <?=$disabled?>  value="0" <?php if( $exam['status_id'] ) echo 'checked="checked"'; ?> class="dontserializeme toggle exam_status"/>
