...
@section('page-breadcrumb')
	<ul class="page-breadcrumb breadcrumb">
		...
		<li>
			<a href="{{ get_mod_route('performance_master') }}">{{ lang('scorecard.performance_master') }}</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
	...
	<div class="col-md-9">
		<div class="portlet">
			<div class="portlet-body">
				<div >
					<ul class="nav nav-tabs ">
						@if ($allow_scorecard)
						<li class="active"><a href="{{ site_url('admin/scorecard') }}">Balance Scorecard</a></li>
						@endif
						@if ($allow_library)
						<li class=""><a href="{{ site_url('admin/library') }}">Library</a></li>
						@endif
						@if ($allow_rating_scale)
						<li class="hidden"><a href="{{ site_url('admin/rating_group') }}">Rating Scale</a></li>
						@endif
						@if ($allow_performance)
						<li class=""><a href="{{ site_url('admin/performance') }}">Performance Type</a></li>
						@endif
						@if ($allow_notification)
						<li class="hidden"><a href="{{ site_url('admin/notification') }}">Notification</a></li>
						@endif
					</ul>
				</div>
			</div>
			...
			<div class="portlet-title">
				<div class="caption"><i class="fa {{ $mod->icon}}"></i>List of Scorecards</div>
