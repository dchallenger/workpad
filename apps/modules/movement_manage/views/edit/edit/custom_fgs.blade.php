			...
			<table class="table table-condensed table-striped table-hover">
				<thead>
					<tr>
						...
						<th width="18%" class="hidden-xs">Effective</th>
						<th width="18%" class="hidden-xs">Status</th>
						<th width="20%" class="hidden-xs">Remarks</th>
				...
				<tbody id="movement_details-list">
					...
					<tr class="record">
						...
						<td class="hidden-xs">
								<?php echo ($movement_detail['effectivity_date'] && $movement_detail['effectivity_date'] != '0000-00-00' && $movement_detail['effectivity_date'] != 'November 30, -0001' && $movement_detail['effectivity_date'] != 'January 01, 1970') ? date('F d, Y', strtotime($movement_detail['effectivity_date'])) : '' ?>	
						</td>
						<td class="hidden-xs">
					        @if( $movement_detail['act_status_id'] == 6 )
					            <span class="badge badge-success"><?php echo $movement_detail['status']; ?></span>
					        @elseif( $movement_detail['act_status_id'] == 5 )
					            <span class="badge badge-default"><?php echo $movement_detail['status']; ?></span>
