<?php
	...
	$db->where('users_profile.reports_to_id', $user_id);
		...
		<div class="form-group">
			...
			<div class="col-md-7">
				<div class="input-group">
					...
					<input type="hidden" name="partners_movement_action[action_id]" id="partners_movement_action-action_id" value="<?php echo (isset($record['partners_movement_action.action_id']) ? $record['partners_movement_action.action_id'] : '') ?>" />
					<span class="input-group-addon">
						<i class="fa fa-list-ul"></i>
					</span>
					<select name="partners_movement_action[user_id]" id="partners_movement_action-user_id"  class="form-control form-select partner_id select2me" data-placeholder="Select...">
					<option value=""></option>
						<?php 
		...
		<div class="form-group">
			...
			<div class="col-md-7">
				...
				<div class="input-group">
					...
					<select name="partners_movement[due_to_id]" id="partners_movement-due_to_id" class="form-control form-select select2me" data-placeholder="Select...">
					 <option value=""></option>
						<?php 
    ...
    <div class="row" align="center">
        <div class="col-md-12">
            <div>
				...
				<button class="btn green btn-sm" type="button" onclick="save_movement( $(this).closest('form'), 2)"></i> Submit</button>                 
                <?php
					}elseif( in_array($record['partners_movement.status_id'], array(1, 2)) ){
				?>
				<button class="btn green btn-sm" type="button" onclick="save_movement( $(this).closest('form'), 2)"><i class="fa fa-check"></i> Submit</button>  
				<?php
					}
				?>                              
