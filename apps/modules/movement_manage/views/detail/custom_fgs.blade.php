					...
					if(count($movement_details) > 0){
						foreach($movement_details as $index => $movement_detail){
							...
							<tr class="record">
								...
								<td class="hidden-xs">
									<?php echo ($movement_detail['effectivity_date'] && $movement_detail['effectivity_date'] != '0000-00-00' && $movement_detail['effectivity_date'] != 'January 01, 1970' && $movement_detail['effectivity_date'] != '1970-01-01') ? date('F d, Y', strtotime($movement_detail['effectivity_date'])) : '' ?>	
								</td>
								<td class="hidden-xs">
