<div class="portlet">
	...
	<div class="portlet-body form">
		...
		<div class="form-group" {{ ($record['recruitment_request.nature_id'] != 5) ? 'style="display:none"' : '' }} hidden>
			<label class="control-label col-md-3">
			{{ lang('mrf.replace_of') }}
			</label>
			<div class="col-md-5">
		...
		<div class="form-group due_to" {{ ($record['recruitment_request.nature_id'] != 5) ? 'style="display:none"' : '' }} hidden>
			<label class="control-label col-md-3">
			{{ lang('mrf.due_to') }}
			</label>
			<div class="col-md-5">
		...
		<div class="form-group location" {{ ($record['recruitment_request.due_to_id'] == 4) ? '' : 'style="display:none"' }} hidden>
		...
		<div class="form-group date_from" {{ ($record['recruitment_request.due_to_id'] != 5) ? 'style="display:none"' : '' }} hidden>
			<label class="control-label col-md-3">
		...
		<div class="form-group date_to" {{ ($record['recruitment_request.due_to_id'] != 5) ? 'style="display:none"' : '' }} hidden>
			<label class="control-label col-md-3">
