...
class loan_application_manage_model extends Record
{
	var $mod_id;
	var $mod_code;
	var $route;
	...
	{
		$this->mod_id = 265;
		$this->mod_code = 'loan_application_manage';
		$this->route = 'partners/loan_application_manage';
		$this->url = site_url('partners/loan_application_manage');
