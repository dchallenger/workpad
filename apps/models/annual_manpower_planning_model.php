...
class annual_manpower_planning_model extends Record
{
	var $mod_id;
	var $mod_code;
	var $route;
	...
	{
		$this->mod_id = 120;
		$this->mod_code = 'annual_manpower_planning';
		$this->route = 'recruitment/annual_manpower_planning';
		$this->url = site_url('recruitment/annual_manpower_planning');
		$this->primary_key = 'plan_id';
		$this->table = 'recruitment_manpower_plan';
		$this->icon = 'fa-folder';
		$this->short_name = 'Annual Manpower Planning';
		$this->long_name  = 'Annual Manpower Planning';
		$this->description = 'Annual Manpower Planning';
		$this->path = APPPATH . 'modules/annual_manpower_planning/';
