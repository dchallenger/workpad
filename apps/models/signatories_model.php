...
/*			'position_id' => $position_id,
	...
	{
		$qry = "select * from (";
		$qry .= "select id from {$this->db->dbprefix}approver_class_company where approver_id = {$approver_id} and approver = 1 and deleted = 0";
		$qry .= " UNION ";
		$qry .= "select id from {$this->db->dbprefix}approver_class_department where approver_id = {$approver_id} and approver = 1 and deleted = 0";
		$qry .= " UNION ";
		$qry .= "select id from {$this->db->dbprefix}approver_class_position where approver_id = {$approver_id} and approver = 1 and deleted = 0";
		$qry .= " UNION ";
		$qry .= "select id from {$this->db->dbprefix}approver_class_user where approver_id = {$approver_id} and approver = 1 and deleted = 0";
		$qry .= ") as t1";
	...
	function select_existing_pending_performance($class_id=0, $user_id=0, $position_id=0, $department_id=0, $company_id=0){
	...
	function update_existing_performance_approvers($class_id=0, $user_id=0, $position_id=0, $department_id=0, $company_id=0){
