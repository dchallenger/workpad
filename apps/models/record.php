					...
					if( $field ){
						...
						{								
							...
							switch( $field['uitype_id'] )
							{
								...
								case 19:
								case 21:
									$save[$table][$field['column'].'_from'] = $this->my_aes->encrypt( $save[$table][$field['column'].'_from'] );
									$$save[$table][$field['column'].'_to'] = $this->my_aes->encrypt( $save[$table][$field['column'].'_to'] );
									break;
								default:
									$save[$table][$column] = $this->my_aes->encrypt($value);//$this->aes->encrypt( $value );
							}
						}
