...
class users_model extends Record
{
	...
	function _get_list($start, $limit, $search, $filter, $trash = false)
	{
		...
		$qry .= " ORDER BY {$this->db->dbprefix}users_profile.firstname";
	...
	function _create_config( $user_id )
	{
		...
		$qry = "SELECT get_sensitivity(a.role_id) as sensitivity, a.role_id, b.business_level_id, a.language, a.login, a.email, a.timezone, b.lastname, b.firstname, b.middlename, b.suffix, IF(b.photo != '',b.photo,'uploads/users/avatar.png') as photo
		...
		if ($user->photo == '')
			$user->photo = 'uploads/users/avatar.png';
