...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = false, $error_messages = null) {
        require(APPPATH.'config/uploadhandler'.EXT);
        ...
        $this->options = array(
            ...
            //Added txt on acceptable file types
            'accept_file_types' => '/\.(gif|jpe?g|png|pdf|doc|docx|xls|xlsx|txt|dat)$/i',
    ...
    protected function create_scaled_image($file_name, $version, $options) {
        ...
        if (!empty($version)) {
            ...
            if (!is_dir($version_dir)) {
                ...
                copy(APPPATH .'index.html', $version_dir.'index.html');
            }
    ...
    function get_config_bytes($val) {
        ...
        return $this->fix_integer_overflow($value);
    }
    ...
    protected function validate($uploaded_file, $file, $error, $index) {
        ...
        if (!preg_match($this->options['accept_file_types'], $file->name)) {
            $file->error = $this->get_error_message('accept_file_types').' for '.$file->name;
            return false;
        }
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if (!is_dir($upload_dir)) {
                ...
                copy(APPPATH .'index.html', $upload_dir.'index.html');
            }
