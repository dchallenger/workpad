...
/*    if ($('#performance_planning-template_id').val() != '') {
    ...
    $('#performance_planning-template_id').change(function(){
        if($(this).val()){
            get_selection_filters( $(this).val() );
        }else{
...
function get_selection_filters(template_id, filter_by, filter_id, planning_id, employment_status_id){
    data = {
        ...
        filter_by : filter_by, //no use for oclp
        filter_id : filter_id, //no use for oclp
        planning_id : planning_id, //no use for oclp
        employment_status_id : employment_status_id //no use for oclp
    }
    $.ajax({
