$(document).ready(function(){
    ...
    $('#users_division-division_id').multiselect();
    ...
    $('#form_type').change(function () {
        ...
        if(form_type != 0){
            ...
            //division select all
            $('#users_division-division_id option').attr('selected', 'selected');
            $('input[name="multiselect_users_division-division_id"]').each( function() {
                $(this).attr('checked',true);
                $(this).attr('aria-selected',true);
            });
            $("#users_division-division_id").multiselect("destroy");
            $('#users_division-division_id').multiselect({
              numberDisplayed: $('input[name="multiselect_users_division-division_id"]').length
            });            
    ...
    $('#users_company-company_id').change(function(){
        ...
        update_employees( $('#users_location-location_id').val(), $('#users_company-company_id').val(), $('#users_division-division_id').val(), $('#users_department-department_id').val());
    });
...
function update_employees( location_id, company_id, division_id, department_id, form_type)
{
    if( (location_id != "" && location_id != null) || (division_id != "" && division_id != null) || (department_id != "" && department_id != null))
    {
