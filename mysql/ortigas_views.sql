...
MySQL - 10.4.13-MariaDB : Database - ortigas
*********************************************************************
*/
...
/*!50001 CREATE TABLE  `applicant_details`(
 ...
 `position_desired` mediumtext ,
 `desired_salary` mediumtext ,
 `fullname` varchar(66) ,
 ...
 `present_address_no` mediumtext ,
 `present_address_street` mediumtext ,
 `present_address_village` mediumtext ,
 `present_address_barangay` mediumtext ,
 `present_address_town` mediumtext ,
 `present_address_city_town` mediumtext ,
 `present_address_province` mediumtext ,
 `present_address_country` mediumtext ,
 `present_address` longtext ,
 `present_province` longtext ,
 `phone` mediumtext ,
 `mobile` mediumtext ,
 `birth_place` mediumtext ,
 `height` mediumtext ,
 `weight` mediumtext ,
 `religion` mediumtext ,
 `citizenship` mediumtext ,
 `civil_status` mediumtext ,
 `tin_number` mediumtext ,
 `sss_number` mediumtext ,
 `pagibig_number` mediumtext ,
 `philhealth_number` mediumtext ,
 `emergency_name` mediumtext ,
 `emergency_phone` mediumtext ,
 `emergency_relationship` mediumtext ,
 `language` mediumtext ,
 `dialect` mediumtext ,
 `interests_hobbies` mediumtext ,
 `machine_operated` mediumtext ,
 `driver_license` mediumtext ,
 `driver_type_license` mediumtext ,
 `prc_license` mediumtext ,
 `prc_type_license` mediumtext ,
 `prc_license_no` mediumtext ,
 `prc_date_expiration` mediumtext ,
 `illness_question` mediumtext ,
 `illness_yes` mediumtext ,
 `trial_court` mediumtext ,
 `how_hiring_heard` mediumtext ,
 `work_start` mediumtext ,
 `referred_employee` mediumtext ,
...
/*!50001 CREATE TABLE  `applicant_personal`(
 ...
 `emergency_city` mediumtext ,
 `emergency_country` mediumtext ,
 `language` mediumtext ,
 `dialect` mediumtext ,
 `interests_hobbies` mediumtext ,
 `machine_operated` mediumtext ,
...
/*!50001 CREATE TABLE  `applicant_personal_history`(
 ...
 `brother_name` mediumtext ,
 `sister_name` mediumtext ,
 `son_name` mediumtext ,
 `daughter_name` mediumtext ,
 `guardian_name` mediumtext ,
 `spouse_name` mediumtext ,
 `father_occupation` mediumtext ,
 `mother_occupation` mediumtext ,
 `brother_occupation` mediumtext ,
 `sister_occupation` mediumtext ,
 `son_occupation` mediumtext ,
 `daughter_occupation` mediumtext ,
 `guardian_occupation` mediumtext ,
 `spouse_occupation` mediumtext ,
 `father_age` mediumtext ,
 `mother_age` mediumtext ,
 `brother_age` mediumtext ,
 `sister_age` mediumtext ,
 `son_age` mediumtext ,
 `daughter_age` mediumtext ,
 `guardian_age` mediumtext ,
 `spouse_age` mediumtext ,
...
/*!50001 CREATE TABLE  `incident_report`(
 ...
 `date_serve` varchar(19) ,
 `remarks` text ,
 `ir_closed_date` varchar(19) ,
 `superior` varchar(64) ,
 `offense` text ,
...
/*!50001 CREATE TABLE  `partners_personal`(
 ...
 `mobile_3` mediumtext ,
 `address` mediumtext ,
 `city_town` mediumtext ,
 `country` mediumtext ,
 `zip_code` mediumtext ,
 `emergency_name` mediumtext ,
 `emergency_relationship` mediumtext ,
 `emergency_phone` mediumtext ,
 `emergency_mobile` mediumtext ,
 `emergency_address` mediumtext ,
 `emergency_city` mediumtext ,
 `emergency_country` mediumtext ,
 `emergency_zip_code` mediumtext ,
 `taxcode` mediumtext ,
 `sss_number` mediumtext ,
 `pagibig_number` mediumtext ,
 `philhealth_number` mediumtext ,
 `tin_number` mediumtext ,
 `bank_account_number_savings` mediumtext ,
 `bank_account_number_current` mediumtext ,
 `bank_account_name` mediumtext ,
 `gender` mediumtext ,
 `birth_place` mediumtext ,
 `religion` mediumtext ,
 `nationality` mediumtext ,
 `civil_status` mediumtext ,
 `solo_parent` mediumtext 
)*/;
...
/*!50001 CREATE TABLE  `partners_personal_history_accountabilities`(
 ...
 `code` mediumtext ,
 `qty` mediumtext ,
 `date_issued` mediumtext ,
 `date_returned` mediumtext ,
 `remarks` mediumtext ,
 `photo` mediumtext 
)*/;
...
/*!50001 CREATE TABLE  `partner_manpower_status_report`(
 ...
 `count` bigint(21) ,
 `employed` decimal(22,0) ,
 `resigned` decimal(22,0) 
)*/;
...
/*!50001 CREATE TABLE  `partner_movement`(
 ...
 `employee_name` mediumtext ,
 `movement_type` mediumtext ,
 `cause` varchar(32) ,
 `deleted` tinyint(1) ,
 `created_by` int(11) 
)*/;
...
/*!50001 CREATE TABLE  `payroll_payslip`(
 ...
 `sp_x8_otnd` int(1) ,
 `rest_sp_otnd` int(1) ,
 `rest_sp_x8_otnd` int(1) ,
 `legal_otnd` int(1) ,
 `legal_x8_otnd` int(1) ,
 `rest_legal_otnd` int(1) ,
 `rest_leg_x8_otnd` int(1) ,
 `nd_hrs` int(1) ,
 `reg_hrs` int(1) ,
 `rest_hrs` int(1) ,
 `rest_x8_hrs` int(1) ,
 ...
 `sp_x8_hrs` int(1) ,
 `rest_sp_hrs` int(1) ,
 `rest_sp_x8_hrs` int(1) ,
 `legal_hrs` int(1) ,
 `legal_x8_hrs` int(1) ,
 `rest_legal_hrs` int(1) ,
 `rest_leg_x8_hrs` int(1) ,
 `health_card` int(1) ,
 `other_deduction_one` int(1) ,
 `other_deduction_two` int(1) ,
 `other_deduction_three` int(1) ,
...
/*!50001 CREATE TABLE  `time_shift_logs`(
 ...
 `shift_time_end` time ,
 `logs_time_in` varchar(19) ,
 `logs_time_out` varchar(19) 
)*/;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `dashboard_notification` AS (select `wsf`.`id` AS `id`,`wsf`.`status` AS `status`,`wsf`.`message_type` AS `message_type`,if(`wsf`.`recipient_id` = 0,`sfr`.`user_id`,`wsf`.`recipient_id`) AS `recipient_id`,replace(replace(if(octet_length(`wsf`.`feed_content`) >= 60,concat(`wsf`.`display_name`,'<br>',left(`wsf`.`feed_content`,if(locate('<br>',`wsf`.`feed_content`) > 1,locate('<br>',`wsf`.`feed_content`) - 1,60)),'...'),`wsf`.`feed_content`),'<h4>',''),'</h4>','') AS `feed_content`,`wsf`.`readon` AS `readon`,`gettimeline`(`wsf`.`createdon`) AS `timeline`,`wsf`.`uri` AS `uri`,`wsf`.`record_id` AS `record_id`,`wsf`.`reactedon` AS `reactedon`,`wsf`.`createdon` AS `createdon` from (`ww_system_feeds` `wsf` left join `ww_system_feeds_recipient` `sfr` on(`sfr`.`id` = `wsf`.`id`)) where `wsf`.`deleted` = 0 order by `wsf`.`createdon` desc) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `payroll_sss_loan_to_disk_report` AS select `uc`.`company_id` AS `company_id`,`uc`.`company` AS `company`,ifnull(`uc`.`sss_branch_code`,'00') AS `sss_branch_code`,`d`.`department_id` AS `department_id`,`d`.`department` AS `department`,`u`.`branch_id` AS `branch_id`,`b`.`branch` AS `branch`,replace(`uc`.`sss`,'-','') AS `sss`,`u`.`user_id` AS `user_id`,`p`.`id_number` AS `id_number`,`pp`.`sss_no` AS `sss_no`,year(`lp`.`payroll_date`) AS `year`,month(`lp`.`payroll_date`) AS `month_id`,`m`.`month` AS `month`,`pl`.`partner_loan_id` AS `partner_loan_id`,concat(replace(`u`.`lastname`,' *',''),', ',`u`.`firstname`,' ',`u`.`middlename`) AS `employee_name`,`u`.`lastname` AS `lastname`,`u`.`firstname` AS `firstname`,`u`.`middlename` AS `middlename`,`u`.`suffix` AS `suffix`,`lt`.`loan_code` AS `loan_code`,`pl`.`entry_date` AS `release_date`,`lt`.`loan_type_id` AS `loan_type_id`,ifnull(round(aes_decrypt(`pl`.`loan_principal`,`encryption_key`()),2),0) AS `loan_principal`,round(sum(aes_decrypt(`lp`.`amount`,`encryption_key`())),2) AS `current`,0.00 AS `overdue`,round(sum(aes_decrypt(`lp`.`amount`,`encryption_key`())),2) AS `due`,'' AS `remarks`,if(`p`.`resigned_date` is null or `p`.`resigned_date` = '0000-00-00','/ /',`p`.`resigned_date`) AS `resigned_date`,concat('10',lpad(replace(`pp`.`sss_no`,'-',''),10,'0'),case when locate('ñ',`u`.`lastname`) <> 'false' then rpad(replace(`u`.`lastname`,' *',''),15,' ') else rpad(replace(`u`.`lastname`,' *',''),15,' ') end,case when locate('ñ',`u`.`firstname`) <> 'false' then rpad(`u`.`firstname`,15,' ') else rpad(`u`.`firstname`,15,' ') end,case when `u`.`middlename` <> '' then rpad(substr(`u`.`middlename`,1,1),2,' ') else rpad('',2,' ') end,`lt`.`loan_code`,date_format(`pl`.`entry_date`,'%y%m%d'),'0',rpad(ifnull(round(aes_decrypt(`pl`.`loan_principal`,`encryption_key`()),0),0),13,'0'),lpad(replace(round(sum(aes_decrypt(`lp`.`amount`,`encryption_key`())),2),'.',''),6,'0')) AS `record`,current_timestamp() AS `document_date` from ((((((((((`ww_payroll_partners_loan` `pl` left join `ww_payroll_partners_loan_payment` `lp` on(`pl`.`partner_loan_id` = `lp`.`partner_loan_id`)) left join `ww_users_profile` `u` on(`pl`.`user_id` = `u`.`user_id`)) left join `ww_partners` `p` on(`pl`.`user_id` = `p`.`user_id`)) left join `ww_payroll_partners` `pp` on(`pl`.`user_id` = `pp`.`user_id`)) left join `ww_users_company` `uc` on(`u`.`company_id` = `uc`.`company_id`)) left join `ww_users_department` `d` on(`u`.`department_id` = `d`.`department_id`)) left join `ww_users_branch` `b` on(`b`.`branch_id` = `u`.`branch_id`)) left join `ww_payroll_loan` `l` on(`pl`.`loan_id` = `l`.`loan_id`)) left join `ww_payroll_loan_type` `lt` on(`l`.`loan_type_id` = `lt`.`loan_type_id`)) left join `ww_month` `m` on(month(`lp`.`date_paid`) = `m`.`month_id`)) where `lt`.`loan_type` like '%SSS%' and `lt`.`deleted` = 0 and `pl`.`deleted` = 0 and `lp`.`deleted` = 0 group by `uc`.`company_id`,`uc`.`company`,`uc`.`sss`,`u`.`user_id`,`p`.`id_number`,`pp`.`sss_no`,year(`lp`.`date_paid`),month(`lp`.`date_paid`),`m`.`month`,`pl`.`partner_loan_id`,`lt`.`loan_code`,`pl`.`release_date` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `users_profile` AS (select `u`.`user_id` AS `user_id`,`up`.`partner_id` AS `partner_id`,`up`.`coordinator_id` AS `coordinator_id`,`up`.`recruit_id` AS `recruit_id`,`u`.`display_name` AS `display_name`,`up`.`title` AS `title`,`up`.`suffix` AS `suffix`,`up`.`lastname` AS `lastname`,`up`.`firstname` AS `firstname`,`up`.`middlename` AS `middlename`,`up`.`maidenname` AS `maidenname`,`up`.`nickname` AS `nickname`,`up`.`project_id` AS `project_id`,`up`.`company` AS `company`,`up`.`company_id` AS `company_id`,`up`.`group_id` AS `group_id`,`up`.`division_id` AS `division_id`,`up`.`department_id` AS `department_id`,`up`.`sbu_unit_id` AS `sbu_unit_id`,`up`.`sbu_unit` AS `sbu_unit`,`up`.`section_id` AS `section_id`,`up`.`v_section` AS `section`,`up`.`branch_id` AS `branch_id`,`up`.`position_id` AS `position_id`,`up`.`reports_to_id` AS `reports_to_id`,`up`.`project_hr_id` AS `project_hr_id`,`up`.`job_title_id` AS `job_title_id`,`up`.`location_id` AS `location_id`,`up`.`photo` AS `photo`,`up`.`birth_date` AS `birth_date`,`getage`(`up`.`birth_date`) AS `age`,ifnull(trim(`pp`.`key_value`),'') AS `gender`,`u`.`active` AS `active` from ((`ww_users_profile` `up` join `ww_users` `u` on(`u`.`user_id` = `up`.`user_id` and `u`.`deleted` = 0)) left join `ww_partners_personal` `pp` on(`pp`.`deleted` = 0 and `pp`.`partner_id` = `up`.`partner_id` and `pp`.`key` = 'gender'))) */;
